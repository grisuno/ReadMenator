...
**Total Files Parsed:** 76 | **Total Symbols Extracted:** 1008 | **Total Imports:** 471
...
| 2 | `_category.py` | 0.2637 | 0.3415 | 0.3195 | 0.00 | 0.46 |
...
**Query anchors:** tests/test_rule_gen.py, tests/test_documentation.py, readmenator/_documentation.py, tests/test_ranking.py, readmenator/_rule_gen.py
...
- How are the 50 files in 'readmenator' related to each other?
...
| `_category.py` | 0.309 | 0.206 | 0.247 | 26 | 14 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 867 total | py | 867 |
