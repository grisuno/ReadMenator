...
**Total Files Parsed:** 74 | **Total Symbols Extracted:** 958 | **Total Imports:** 434
 | **Resolved Imports:** 203

<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:c26c348 | date:2026-07-18 -->
...
|------|---------|---------|----------|
| `__init__.py` | 23 | 2 | py |
| `_pipeline.py` | 18 | 21 | py |
| `_app.py` | 15 | 30 | py |
| `readmenator_orchestrator.py` | 14 | 34 | py |
| `__main__.py` | 11 | 3 | py |
| `_mcp_server.py` | 11 | 52 | py |
| `_exporter.py` | 10 | 14 | py |
| `_documentation.py` | 9 | 26 | py |
| `test_documentation.py` | 9 | 29 | py |
| `test_mcp_server.py` | 9 | 25 | py |
...
- `_app.py` (py, 30 symbols)
- `_category.py` (py, 25 symbols)
- `_cpg.py` (py, 5 symbols)
- `_documentation.py` (py, 26 symbols)
...
- `test_mcp_server.py` (py, 25 symbols)
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3394 | 0.3719 | 0.3603 | 0.00 | 1.00 |
| 2 | `_category.py` | 0.2659 | 0.3415 | 0.3211 | 0.00 | 0.48 |
| 3 | `_config.py` | 0.1301 | 0.0425 | 0.0552 | 0.00 | 1.00 |
| 4 | `_rule_gen.py` | 0.1111 | 0.0478 | 0.0038 | 0.00 | 0.89 |
| 5 | `_base.py` | 0.1055 | 0.0000 | 0.0277 | 0.00 | 1.00 |
| 6 | `_resolver.py` | 0.1011 | 0.0000 | 0.0057 | 0.00 | 1.00 |
| 7 | `_query.py` | 0.1011 | 0.0000 | 0.0054 | 0.00 | 1.00 |
| 8 | `_layers.py` | 0.1009 | 0.0000 | 0.0043 | 0.00 | 1.00 |
| 9 | `_analyzer.py` | 0.1008 | 0.0000 | 0.0038 | 0.00 | 1.00 |
| 10 | `_scanner.py` | 0.1008 | 0.0000 | 0.0038 | 0.00 | 1.00 |

**Query anchors:** readmenator/_rule_gen.py, tests/test_documentation.py, tests/test_ranking.py, tests/test_rule_gen.py, readmenator/_documentation.py

**Top result justification paths:**

  `_rule_gen.py -> _models.py`
...
|------|-------|-------------|----------|
| `_models.py` | 111.5 | | 0.3603 |
| `_config.py` | 70.1 | | 0.0552 |
| `__init__.py` | 48.2 | | 0.0000 |
| `_base.py` | 44.6 | | 0.0277 |
| `_pipeline.py` | 36.1 | | 0.0000 |
| `_app.py` | 31.0 | | 0.0000 |
| `_mcp_server.py` | 21.2 | | 0.0000 |
| `_category.py` | 18.5 | | 0.3211 |
| `_rank.py` | 17.7 | | 0.0000 |
| `test_ranking.py` | 17.2 | | 0.0000 |
...
### readmenator (Cohesion: 0.84)

**51 files** in this community:
...
### readmenator/parsers (Cohesion: 0.61)
...
- `__init__.py` <-> `test_resolver.py` (4 hops, across 2 communities)
- `_assembly.py` <-> `test_resolver.py` (4 hops, across 2 communities)
- `_base.py` <-> `test_resolver.py` (4 hops, across 2 communities)
- `_c.py` <-> `test_resolver.py` (4 hops, across 2 communities)
...
- What does _models.py depend on, and what depends on it? (55 connections)
...
- How are the 51 files in 'readmenator' related to each other?
...
**Taint Sources:** 2 | **Taint Sinks:** 8 | **Propagation Paths:** 8
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.179 | 1.000 | 0.671 | 15 | 66 |
| `_category.py` | 0.298 | 0.212 | 0.246 | 25 | 14 |
| `_config.py` | 0.012 | 0.606 | 0.368 | 1 | 40 |
| `_rule_gen.py` | 0.107 | 0.182 | 0.152 | 9 | 12 |
| `_base.py` | 0.071 | 0.409 | 0.274 | 6 | 27 |
| `_resolver.py` | 0.131 | 0.091 | 0.107 | 11 | 6 |
| `_query.py` | 0.202 | 0.182 | 0.190 | 17 | 12 |
| `_layers.py` | 0.048 | 0.106 | 0.083 | 4 | 7 |
| `_analyzer.py` | 0.155 | 0.151 | 0.153 | 13 | 10 |
| `_scanner.py` | 0.155 | 0.197 | 0.180 | 13 | 13 |
| `test_ranking.py` | 0.857 | 0.197 | 0.461 | 72 | 13 |
| `test_parsers.py` | 1.000 | 0.091 | 0.455 | 84 | 6 |
| `__init__.py` | 0.024 | 0.712 | 0.437 | 2 | 47 |
| `_app.py` | 0.357 | 0.470 | 0.425 | 30 | 31 |
| `_mcp_server.py` | 0.619 | 0.288 | 0.420 | 52 | 19 |
...
|------|------------------|----------------------|--------------|
| `_category.py` | 8 | 49 | 57 |
| `_models.py` | 50 | 0 | 55 |
| `_config.py` | 35 | 19 | 54 |
| `_base.py` | 20 | 12 | 32 |
| `_rank.py` | 7 | 7 | 14 |
| `_assembly.py` | 1 | 12 | 13 |
| `_c.py` | 1 | 12 | 13 |
| `_csharp.py` | 1 | 12 | 13 |
| `_dart.py` | 1 | 12 | 13 |
| `_elixir.py` | 1 | 12 | 13 |
| `_gdscript.py` | 1 | 12 | 13 |
| `_go.py` | 1 | 12 | 13 |
| `_java.py` | 1 | 12 | 13 |
| `_javascript.py` | 1 | 12 | 13 |
| `_kotlin.py` | 1 | 12 | 13 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 819 total | py | 819 |
...
- `_run_tests` (line 63) `def _run_tests()`
- `main` (line 78) `def main()`
...
**Classes:**
- `readmenatorApplication` (line 25) `class readmenatorApplication`

**Methods:**
- `__init__` (line 26) `def __init__(self, config)`
- `_scan` (line 35) `def _scan(self, target_dir)`
- `_scan_with_content` (line 43) `def _scan_with_content(self, target_dir)`
- `_resolve_imports` (line 53) `def _resolve_imports(self, nodes, edges, target_dir)`
- `run` (line 72) `def run(self, target_dir, resolve_imports, run_analysis, run_security, run_v2_analysis)`
- `_write_sidecar_outputs` (line 165) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_log_summary` (line 191) `def _log_summary(self, nodes, edges, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 245) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 334) `def _scan_for_cache(self, root, cache)`
- `query` (line 352) `def query(self, target_dir, question)`
- `explain` (line 357) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 369) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 382) `def summary(self, target_dir)`
- `rank_query` (line 387) `def rank_query(self, target_dir, query, top_n)` - *Run a ranked query against the knowledge graph.
...
- `rebuild` (line 417) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 420) `def analyze(self, target_dir)`
- `export_json` (line 424) `def export_json(self, target_dir, output_path)`
- `export_html` (line 435) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 446) `def export_svg(self, target_dir, output_path)`
- `export` (line 457) `def export(self, target_dir)`
- `export_graphml` (line 462) `def export_graphml(self, target_dir, output_path)`
- `export_obsidian` (line 473) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 483) `def watch(self, target_dir)`
- `audit` (line 493) `def audit(self, target_dir)`
- `audit_deep` (line 500) `def audit_deep(self, target_dir)`
- `export_sarif` (line 520) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 530) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 540) `def detect_layers(self, target_dir)`
- `on_change` (line 487) `def on_change()`
...
**Classes:**
- `EdgeKind` (line 24) `class EdgeKind(StrEnum)` - *Semantic type of a morphism between two code artifacts.*
- `Morphism` (line 54) `class Morphism` - *A typed directed edge between two code artifacts.
...
- `Category` (line 75) `class Category` - *A category of code artifacts with typed morphisms.

Objects are node IDs (file paths or symbol identifiers).
Morphisms are typed directed edges. Composition follows
compatible source/target chains respecting edge-kind semantics.*
- `TypedGraph` (line 178) `class TypedGraph` - *Weighted directed graph for PageRank computations.

Converts a Category into a stochastic transition matrix suitable
for eigenvalue computation, preserving edge kind weights.*

**Methods:**
- `build_category_from_edges` (line 233) `def build_category_from_edges(edges, resolved_edges, node_ids)` - *Build a Category from lists of Edge objects.
...
- `_infer_edge_kind` (line 277) `def _infer_edge_kind(relation)` - *Map a relation string to an EdgeKind.

Falls back to DEPENDS_ON for unrecognised strings.*
- `weight` (line 70) `def weight(self)` - *Effective weight for ranking = semantic weight * confidence.*
- `__init__` (line 83) `def __init__(self)`
- `add_object` (line 89) `def add_object(self, obj_id)`
- `add_morphism` (line 92) `def add_morphism(self, m)`
- `objects` (line 100) `def objects(self)`
- `morphisms` (line 104) `def morphisms(self)`
- `outgoing` (line 107) `def outgoing(self, obj_id)`
- `incoming` (line 110) `def incoming(self, obj_id)`
- `compose` (line 113) `def compose(self, a, b)` - *Compose two morphisms if target of a matches source of b.

Returns a new Morphism with composite kind, or None if
the kinds are incompatible.*
- `paths` (line 130) `def paths(self, source, target, max_depth)` - *Find all composition paths from source to target up to max_depth.*
- `_compose_kind` (line 154) `def _compose_kind(a, b)` - *Determine the composite edge kind.
...
- `__init__` (line 185) `def __init__(self, category)`
- `_compute_out_weights` (line 194) `def _compute_out_weights(self)`
- `nodes` (line 200) `def nodes(self)`
- `size` (line 204) `def size(self)`
- `node_index` (line 207) `def node_index(self, node_id)`
- `transition_weight` (line 210) `def transition_weight(self, source, target)` - *Sum of weights of all morphisms from source to target.*
- `stochastic_row` (line 218) `def stochastic_row(self, source)` - *Return dict of target -> probability for the row of *source*.

Probabilities sum to 1.0 if source has outgoing edges.
Returns empty dict for dangling nodes.*
- `dfs` (line 136) `def dfs(current, goal, path, depth)`
...
**Classes:**
- `DocumentationGenerator` (line 26) `class DocumentationGenerator` - *Builds the KNOWLEDGE_BASE.md document from scanned nodes and edges.
...
**Methods:**
- `__init__` (line 38) `def __init__(self, config)`
- `_ranking_version` (line 52) `def _ranking_version(self)`
- `_get_git_commit` (line 70) `def _get_git_commit()`
- `generate` (line 80) `def generate(self, nodes, edges, resolved_edges, analysis, layers, findings, analysis_v2, ranked)`
- `_apply_context_budget` (line 152) `def _apply_context_budget(self, content, nodes, edges, resolved_edges, analysis, analysis_v2, findings)`
- `_build_toc` (line 289) `def _build_toc(self, nodes, analysis, layers, findings, analysis_v2, is_truncated, ranked)`
- `_build_layers` (line 372) `def _build_layers(self, layers, nodes)`
- `_build_dashboard` (line 406) `def _build_dashboard(self, nodes, edges, resolved_edges)`
- `_build_god_nodes` (line 486) `def _build_god_nodes(self, analysis, ranked)`
- `_build_community_analysis` (line 514) `def _build_community_analysis(self, analysis, nodes)`
- `_build_surprising_connections` (line 547) `def _build_surprising_connections(self, analysis, nodes)`
- `_build_suggested_questions` (line 572) `def _build_suggested_questions(self, analysis)`
- `_build_ranked_context` (line 588) `def _build_ranked_context(self, ranked)`
- `_build_orphans` (line 634) `def _build_orphans(self, nodes, analysis_v2, ranked)` - *Build a section listing nodes with low coverage signals.*
- `_build_query_recipes` (line 684) `def _build_query_recipes(self)`
- `_build_taint_analysis` (line 726) `def _build_taint_analysis(self, analysis_v2)`
- `_build_hotspots` (line 761) `def _build_hotspots(self, analysis_v2, ranked)`
- `_build_dependency_cycles` (line 799) `def _build_dependency_cycles(self, analysis_v2)`
- `_build_change_impact` (line 819) `def _build_change_impact(self, analysis_v2)`
- `_build_layer_violations` (line 844) `def _build_layer_violations(self, analysis_v2)`
- `_build_suggested_rules` (line 872) `def _build_suggested_rules(self, analysis_v2)`
- `_build_security_findings` (line 897) `def _build_security_findings(self, findings)`
- `_build_mermaid_section` (line 944) `def _build_mermaid_section(self, graph_output, is_truncated)`
- `_build_cpg_block` (line 967) `def _build_cpg_block(self, nodes, edges, resolved_edges, analysis)`
- `_build_architecture_reference` (line 993) `def _build_architecture_reference(self, nodes, edges)`
...
- `CommunityResult` (line 109) `class CommunityResult` - *Result of community detection on the import graph.
...
- `AnalysisResult` (line 128) `class AnalysisResult` - *Complete graph analysis output.
...
- `TaintPath` (line 149) `class TaintPath` - *A taint propagation path from source to sink through the import graph.
...
- `TaintAnalysisResult` (line 170) `class TaintAnalysisResult` - *Complete taint propagation analysis output.

Attributes:
    paths: List of TaintPath instances discovered.
    source_count: Number of unique taint source files.
    sink_count: Number of unique taint sink files.*
- `DependencyCycle` (line 185) `class DependencyCycle` - *A cycle detected in the resolved import graph.

Attributes:
    cycle: List of file node IDs forming the cycle.
    length: Number of files in the cycle.*
- `ChangeImpact` (line 198) `class ChangeImpact` - *Change impact analysis for a single file.
...
- `HotspotResult` (line 215) `class HotspotResult` - *A hotspot file combining complexity and centrality metrics.
...
- `SuggestedRule` (line 236) `class SuggestedRule` - *A suggested linting/security rule derived from code patterns.
...
- `LayerViolation` (line 261) `class LayerViolation` - *A detected architectural layer violation.
...
- `AnalysisResultV2` (line 282) `class AnalysisResultV2` - *Extended analysis result combining all new analysis modules.
...
**Methods:**
- `pluralize_symbol_kind` (line 99) `def pluralize_symbol_kind(kind, plural_map)` - *Return the plural form of *kind* according to *plural_map*.
...
**Classes:**
- `AnalyzerFactory` (line 34) `class AnalyzerFactory` - *Lazy factory for all readmenator analyzer and generator instances.

Decouples the application orchestrator from the concrete
instantiation of analysis modules. Each component is created
on first access and cached for the lifetime of the factory.*
- `DeepAnalysisRunner` (line 166) `class DeepAnalysisRunner` - *Orchestrates the extended V2 analysis pipeline.
...
**Methods:**
- `__init__` (line 42) `def __init__(self, config)`
- `scanner` (line 60) `def scanner(self)`
- `generator` (line 66) `def generator(self)`
- `analyzer` (line 72) `def analyzer(self)`
- `security` (line 78) `def security(self)`
- `exporter` (line 84) `def exporter(self)`
- `taint` (line 90) `def taint(self)`
- `hotspots` (line 96) `def hotspots(self)`
- `layer_rules` (line 102) `def layer_rules(self)`
- `rule_gen` (line 108) `def rule_gen(self)`
- `sarif` (line 114) `def sarif(self)`
- `cpg` (line 120) `def cpg(self)`
- `layer_detector` (line 126) `def layer_detector(self)`
- `build_typed_graph` (line 131) `def build_typed_graph(self, nodes, edges, resolved_edges)`
- `make_ranker` (line 141) `def make_ranker(self, typed_graph)` - *Create a CompositeRanker for the given typed graph.*
- `last_category` (line 158) `def last_category(self)`
- `last_typed_graph` (line 162) `def last_typed_graph(self)`
- `__init__` (line 175) `def __init__(self, factory)`
- `run` (line 178) `def run(self, nodes, edges, resolved_edges, layers, content_map)`
