...
**Total Files Parsed:** 69 | **Total Symbols Extracted:** 812 | **Total Imports:** 398
 | **Resolved Imports:** 183
...
| Total Imports | 398 |
| Call Edges | 4311 |
| Inheritance Edges | 70 |
| Languages | 1 |
| Avg Symbols/File | 11.8 |
...
- `_documentation.py` (py, 21 symbols)
...
- `test_hotspots.py` (py, 11 symbols)
- `test_layer_rules.py` (py, 13 symbols)
- `test_rule_gen.py` (py, 10 symbols)
- ... and 3 more files

### readmenator (Cohesion: 0.25)
...
### readmenator/parsers (Cohesion: 0.66)
...
### readmenator (Cohesion: 0.20)

**2 files** in this community:

- `_sarif.py` (py, 5 symbols)
- `test_sarif.py` (py, 10 symbols)
...
- `_cpg.py` <-> `test_resolver.py` (4 hops, across 3 communities)
...
- What does _models.py depend on, and what depends on it? (52 connections)
...
- How are the 11 files in 'readmenator' related to each other?
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.179 | 1.000 | 0.671 | 15 | 61 |
| `__init__.py` | 0.024 | 0.770 | 0.472 | 2 | 47 |
| `test_parsers.py` | 1.000 | 0.098 | 0.459 | 84 | 6 |
| `_mcp_server.py` | 0.619 | 0.311 | 0.434 | 52 | 19 |
| `_app.py` | 0.345 | 0.475 | 0.423 | 29 | 29 |
| `test_security.py` | 0.750 | 0.180 | 0.408 | 63 | 11 |
| `_config.py` | 0.012 | 0.656 | 0.398 | 1 | 40 |
| `_pipeline.py` | 0.202 | 0.508 | 0.386 | 17 | 31 |
| `readmenator_orchestrator.py` | 0.405 | 0.230 | 0.300 | 34 | 14 |
| `test_documentation.py` | 0.345 | 0.262 | 0.295 | 29 | 16 |
| `_base.py` | 0.071 | 0.443 | 0.294 | 6 | 27 |
| `test_mcp_server.py` | 0.298 | 0.197 | 0.237 | 25 | 12 |
| `_security.py` | 0.321 | 0.180 | 0.237 | 27 | 11 |
| `test_parsers_new.py` | 0.429 | 0.098 | 0.230 | 36 | 6 |
| `_documentation.py` | 0.250 | 0.213 | 0.228 | 21 | 13 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 697 total | py | 697 |
...
graph TD
    ...
    subgraph community_3 ["readmenator/parsers"]
    ...
    subgraph community_4 ["readmenator"]
...
- `_write_sidecar_outputs` (line 147) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_log_summary` (line 173) `def _log_summary(self, nodes, edges, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 227) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 316) `def _scan_for_cache(self, root, cache)`
- `query` (line 334) `def query(self, target_dir, question)`
- `explain` (line 339) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 351) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 364) `def summary(self, target_dir)`
- `rebuild` (line 369) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 372) `def analyze(self, target_dir)`
- `export_json` (line 376) `def export_json(self, target_dir, output_path)`
- `export_html` (line 387) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 398) `def export_svg(self, target_dir, output_path)`
- `export` (line 409) `def export(self, target_dir)`
- `export_graphml` (line 414) `def export_graphml(self, target_dir, output_path)`
- `export_obsidian` (line 425) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 435) `def watch(self, target_dir)`
- `audit` (line 445) `def audit(self, target_dir)`
- `audit_deep` (line 452) `def audit_deep(self, target_dir)`
- `export_sarif` (line 472) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 482) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 492) `def detect_layers(self, target_dir)`
- `on_change` (line 439) `def on_change()`
...
- `_apply_context_budget` (line 112) `def _apply_context_budget(self, content, nodes, edges, resolved_edges, analysis, analysis_v2, findings)`
- `_build_toc` (line 249) `def _build_toc(self, nodes, analysis, layers, findings, analysis_v2, is_truncated)`
- `_build_layers` (line 316) `def _build_layers(self, layers, nodes)`
- `_build_dashboard` (line 350) `def _build_dashboard(self, nodes, edges, resolved_edges)`
- `_build_god_nodes` (line 430) `def _build_god_nodes(self, analysis)`
- `_build_community_analysis` (line 450) `def _build_community_analysis(self, analysis, nodes)`
- `_build_surprising_connections` (line 483) `def _build_surprising_connections(self, analysis, nodes)`
- `_build_suggested_questions` (line 508) `def _build_suggested_questions(self, analysis)`
- `_build_taint_analysis` (line 524) `def _build_taint_analysis(self, analysis_v2)`
- `_build_hotspots` (line 559) `def _build_hotspots(self, analysis_v2)`
- `_build_dependency_cycles` (line 585) `def _build_dependency_cycles(self, analysis_v2)`
- `_build_change_impact` (line 605) `def _build_change_impact(self, analysis_v2)`
- `_build_layer_violations` (line 630) `def _build_layer_violations(self, analysis_v2)`
- `_build_suggested_rules` (line 658) `def _build_suggested_rules(self, analysis_v2)`
- `_build_security_findings` (line 683) `def _build_security_findings(self, findings)`
- `_build_mermaid_section` (line 730) `def _build_mermaid_section(self, graph_output, is_truncated)`
- `_build_cpg_block` (line 753) `def _build_cpg_block(self, nodes, edges, resolved_edges, analysis)`
- `_build_architecture_reference` (line 779) `def _build_architecture_reference(self, nodes, edges)`
