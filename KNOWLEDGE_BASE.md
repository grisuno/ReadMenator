...
**Total Files Parsed:** 104 | **Total Symbols Extracted:** 1496 | **Total Imports:** 642
 | **Resolved Imports:** 291

<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:41b5d0f | date:2026-07-18 -->
...
| `_pipeline.py` | 23 | 30 | py |
| `__init__.py` | 23 | 2 | py |
| `test_agent_output.py` | 22 | 41 | py |
| `_app.py` | 19 | 42 | py |
...
- `_agent_output.py` (py, 15 symbols)
- `_analyzer.py` (py, 13 symbols)
- `_app.py` (py, 42 symbols)
...
- `test_agent_output.py` (py, 41 symbols)
...
- `_agent_injector.py` (py, 12 symbols)
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3290 | 0.3550 | 0.3464 | 0.00 | 1.00 |
| 2 | `_category.py` | 0.2493 | 0.3152 | 0.3062 | 0.00 | 0.46 |
| 3 | `_config.py` | 0.1389 | 0.0590 | 0.0619 | 0.00 | 1.00 |
| 4 | `_diagrams.py` | 0.1099 | 0.0204 | 0.0037 | 0.00 | 1.00 |
| 5 | `_base.py` | 0.1046 | 0.0000 | 0.0230 | 0.00 | 1.00 |
| 6 | `_layers.py` | 0.1046 | 0.0077 | 0.0056 | 0.00 | 1.00 |
| 7 | `_rule_gen.py` | 0.1013 | 0.0262 | 0.0030 | 0.00 | 0.89 |
| 8 | `_resolver.py` | 0.1010 | 0.0001 | 0.0050 | 0.00 | 1.00 |
| 9 | `_query.py` | 0.1010 | 0.0002 | 0.0046 | 0.00 | 1.00 |
| 10 | `_scanner.py` | 0.1007 | 0.0000 | 0.0034 | 0.00 | 1.00 |

**Query anchors:** tests/test_ranking.py, tests/test_rule_gen.py, readmenator/_rule_gen.py, readmenator/_agent_output.py, tests/test_documentation.py, tests/test_agent_output.py, readmenator/_linter.py, tests/test_linter.py (+2 more)

**Top result justification paths:**

  `test_ranking.py -> _category.py -> _models.py`
  `test_ranking.py -> _explain.py -> _category.py -> _models.py`
...
|------|-------|-------------|----------|
| `_models.py` | 143.9 | | 0.3464 |
| `_config.py` | 104.1 | | 0.0619 |
| `__init__.py` | 48.2 | | 0.0000 |
| `_pipeline.py` | 47.0 | | 0.0000 |
| `_base.py` | 44.6 | | 0.0230 |
| `_app.py` | 44.2 | | 0.0000 |
| `test_parsers_property.py` | 42.7 | | 0.0000 |
| `_mcp_server.py` | 21.2 | | 0.0000 |
| `_diagrams.py` | 18.7 | | 0.0037 |
...
- What does _models.py depend on, and what depends on it? (71 connections)
- What does _config.py depend on, and what depends on it? (52 connections)
- What does __init__.py depend on, and what depends on it? (24 connections)
- How are the 92 files in 'readmenator' related to each other?
...
**Taint Sources:** 1 | **Taint Sinks:** 34 | **Propagation Paths:** 20
...
- `_agent_injector.py` imports `subprocess` (4 hops to `_query.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py -> _query.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_models.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py -> _models.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_layers.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py -> _layers.py
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.224 | 1.000 | 0.689 | 19 | 84 |
| `_category.py` | 0.306 | 0.167 | 0.222 | 26 | 14 |
| `_config.py` | 0.012 | 0.655 | 0.398 | 1 | 55 |
| `_diagrams.py` | 0.788 | 0.179 | 0.422 | 67 | 15 |
| `_base.py` | 0.071 | 0.321 | 0.221 | 6 | 27 |
| `_layers.py` | 0.047 | 0.107 | 0.083 | 4 | 9 |
| `_rule_gen.py` | 0.106 | 0.143 | 0.128 | 9 | 12 |
| `_resolver.py` | 0.165 | 0.119 | 0.137 | 14 | 10 |
| `_query.py` | 0.200 | 0.143 | 0.166 | 17 | 12 |
| `_scanner.py` | 0.153 | 0.167 | 0.161 | 13 | 14 |
| `test_diagrams.py` | 0.812 | 0.429 | 0.582 | 69 | 36 |
| `_app.py` | 0.494 | 0.476 | 0.483 | 42 | 40 |
| `_pipeline.py` | 0.353 | 0.536 | 0.463 | 30 | 45 |
| `test_parsers_property.py` | 0.318 | 0.548 | 0.456 | 27 | 46 |
| `test_parsers.py` | 1.000 | 0.071 | 0.443 | 85 | 6 |
...
| Cycle | Length | Files |
|-------|--------|-------|
| `_app.py -> _pipeline.py -> _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py` | 6 | 6 |
| `_app.py -> _pipeline.py -> _agent_injector.py -> readmenator.py -> __main__.py` | 5 | 5 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 1291 total | py | 1291 |
...
- `__init__.py` (0 symbols, no doc)
- `test_agent_output.py` (41 symbols, no doc)
...
- `test_parsers.py` (85 symbols, no doc)
...
graph TD
    ...
    readmenator__resolver_py -- resolved_imports --> readmenator__config_py
...
classDiagram
  class _agent_injector_py_AgentInjector {
    ...
    +__init__(self, kb_filename, agent_output_dir, agent_files, agent_globs)
  ...
  class _agent_output_py_AgentOutputGenerator {
    ...
    +_build_security(self, findings)
    +_build_api(self, nodes, resolved_map, imported_by)
    +_build_gotchas(self, analysis, analysis_v2, nodes)
    +_write_subsystem_files(self, out_dir, subsystems, resolved_map, imported_by, layers)
    +_build_subsystem_content(self, name, file_nodes, resolved_map, imported_by, layers)
  }
...
- `_run_tests` (line 105) `def _run_tests()`
- `main` (line 120) `def main()`

#### `_agent_injector.py`
**Path:** `readmenator/_agent_injector.py`

**Classes:**
- `AgentInjector` (line 121) `class AgentInjector` - *Injects a link to KNOWLEDGE_BASE.md into AI agent instruction files.
...
**Functions:**
- `ensure_readmenator_installed` (line 96) `def ensure_readmenator_installed()` - *Check if readmenator is installed via pip; install it if missing.

Returns True if readmenator is available after the check.*

**Methods:**
- `__init__` (line 132) `def __init__(self, kb_filename, agent_output_dir, agent_files, agent_globs)`
- `inject` (line 144) `def inject(self, project_root)` - *Inject KB reference into all discovered agent files.

Returns the number of agent files actually modified.*
- `remove` (line 162) `def remove(self, project_root)` - *Remove KB injection from all discovered agent files.

Returns the number of files actually modified.*
- `find_agent_files` (line 175) `def find_agent_files(self, project_root)` - *Public accessor: return all detected agent files.*
- `_find_agent_files` (line 179) `def _find_agent_files(self, root)`
- `_inject_single` (line 193) `def _inject_single(self, path)`
- `_extract_current_injection` (line 218) `def _extract_current_injection(content)`
- `_remove_old_injection` (line 227) `def _remove_old_injection(content)`
- `_remove_single` (line 237) `def _remove_single(self, path)`
- `_build_injection` (line 253) `def _build_injection(self, fmt)`

#### `_agent_output.py`
**Path:** `readmenator/_agent_output.py`

**Classes:**
- `AgentOutputGenerator` (line 46) `class AgentOutputGenerator` - *Generates agent-friendly, grep-optimised output files.

All output is plain Markdown -- no JSON wrapping, no fenced code
blocks around data structures.  Every line is greppable.*

**Methods:**
- `__init__` (line 53) `def __init__(self, config)`
- `generate` (line 60) `def generate(self, nodes, edges, resolved_edges, analysis, analysis_v2, findings, layers, project_root)` - *Write all agent output files and return the output directory path.*
- `_infer_subsystems` (line 111) `def _infer_subsystems(self, nodes)` - *Group nodes by directory, inferring subsystem names.*
- `_build_index` (line 148) `def _build_index(self, nodes, subsystems)`
- `_build_architecture` (line 178) `def _build_architecture(self, edges, resolved_edges, nodes)`
- `_build_security` (line 222) `def _build_security(self, findings)`
- `_build_api` (line 250) `def _build_api(self, nodes, resolved_map, imported_by)`
- `_build_gotchas` (line 307) `def _build_gotchas(self, analysis, analysis_v2, nodes)`
- `_write_subsystem_files` (line 376) `def _write_subsystem_files(self, out_dir, subsystems, resolved_map, imported_by, layers)`
- `_build_subsystem_content` (line 395) `def _build_subsystem_content(self, name, file_nodes, resolved_map, imported_by, layers)`
- `_write_recipes` (line 445) `def _write_recipes(self, recipes_dir, analysis, analysis_v2)`
- `_build_resolved_map` (line 499) `def _build_resolved_map(resolved_edges)`
- `_build_imported_by_map` (line 508) `def _build_imported_by_map(resolved_edges)`
- `_write` (line 517) `def _write(path, content)`
...
- `_write_sidecar_outputs` (line 190) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_inject_readme_link` (line 216) `def _inject_readme_link(self, root)`
- `_inject_agent_files` (line 224) `def _inject_agent_files(self, root)`
- `generate_uml_code` (line 232) `def generate_uml_code(self, target_dir, language, output_path)`
- `_log_summary` (line 244) `def _log_summary(self, nodes, edges, root, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 299) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 395) `def _scan_for_cache(self, root, cache)`
- `query` (line 413) `def query(self, target_dir, question)`
- `explain` (line 418) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 430) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 443) `def summary(self, target_dir)`
- `rank_query` (line 448) `def rank_query(self, target_dir, query, top_n)` - *Run a ranked query against the knowledge graph.
...
- `rebuild` (line 478) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 481) `def analyze(self, target_dir)`
- `export_json` (line 485) `def export_json(self, target_dir, output_path)`
- `export_html` (line 496) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 507) `def export_svg(self, target_dir, output_path)`
- `export` (line 518) `def export(self, target_dir)`
- `export_graphml` (line 523) `def export_graphml(self, target_dir, output_path)`
- `export_cypher` (line 534) `def export_cypher(self, target_dir, output_path)`
- `export_obsidian` (line 547) `def export_obsidian(self, target_dir, output_dir)`
- `export_diagrams` (line 557) `def export_diagrams(self, target_dir, output_dir)` - *Export all five interactive system maps plus a gallery index.
...
- `_live_renderer` (line 596) `def _live_renderer(self)` - *Return the configured map renderer for published output.

Returns:
    The vis.js renderer when enabled, else the offline renderer.*
- `export_diagram` (line 606) `def export_diagram(self, target_dir, kind, output_path)` - *Export a single interactive system map as standalone HTML.
...
- `export_pages` (line 643) `def export_pages(self, target_dir, output_dir)` - *Publish all system maps plus a gallery index as a static site.
...
- `watch` (line 679) `def watch(self, target_dir)`
- `audit` (line 689) `def audit(self, target_dir)`
- `audit_deep` (line 696) `def audit_deep(self, target_dir)`
- `export_sarif` (line 716) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 726) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 736) `def detect_layers(self, target_dir)`
- `lint` (line 746) `def lint(self, target_dir)`
- `strip_dead_code` (line 759) `def strip_dead_code(self, target_dir)`
- `generate_cursorrules` (line 769) `def generate_cursorrules(self, target_dir)`
- `refactor_monolith` (line 784) `def refactor_monolith(self, target_dir)`
- `on_change` (line 683) `def on_change()`
...
- `VisNetworkRenderer` (line 2027) `class VisNetworkRenderer` - *Renders a system map as a physics-driven vis.js network document.

Fetches the configured vis-network bundle from a CDN at view time,
so pages need network access. Nodes stay draggable with live
physics; use the inline renderer when fully offline output matters.*
- `DocsSitePublisher` (line 2548) `class DocsSitePublisher` - *Publishes validated system maps as a static documentation site.
...
- `write` (line 1446) `def write(self, system_map, output_path)` - *Render a system map and write it to a relative output path.
...
Returns:
    Rendered HTML document that was written.*
- `_safe_json` (line 1465) `def _safe_json(self, payload)` - *Serialize a payload for safe inline script embedding.
...
Returns:
    JSON text with angle brackets unicode-escaped.*
- `_escape` (line 1476) `def _escape(self, value)` - *Escape text for SVG and HTML embedding.
...
Returns:
    Escaped text safe for markup contexts.*
- `_role_color` (line 1487) `def _role_color(self, role)` - *Return the stroke color for a semantic role.
...
Returns:
    Hex color string for the role.*
- `_edge_path` (line 1498) `def _edge_path(self, x1, y1, x2, y2)` - *Compute a deterministic curved route between two nodes.
...
- `_nodes_svg` (line 1534) `def _nodes_svg(self, system_map)` - *Render authored nodes as inline SVG groups.
...
- `_edges_svg` (line 1582) `def _edges_svg(self, system_map)` - *Render authored relationships as inline SVG paths.
...
- `_template` (line 1629) `def _template(self)` - *Return the self-contained viewer document template.

Returns:
    HTML template with replacement tokens for map content.*
- `__init__` (line 2035) `def __init__(self, config)` - *Initialise the renderer with application configuration.

Args:
    config: Central settings for CDN bundle and physics.*
- `render` (line 2043) `def render(self, system_map)` - *Render a system map as a vis.js network HTML document.
...
- `write` (line 2144) `def write(self, system_map, output_path)` - *Render a vis.js map and write it to a relative output path.
...
Returns:
    Rendered HTML document that was written.*
- `_tooltip` (line 2161) `def _tooltip(self, node)` - *Build a documentation tooltip for a network node.
...
- `_template` (line 2192) `def _template(self)` - *Return the vis.js viewer document template.

Returns:
    HTML template with replacement tokens for map content.*
- `__init__` (line 2565) `def __init__(self, config)` - *Initialise the publisher with application configuration.

Args:
    config: Central settings for pages layout and map limits.*
- `description_for` (line 2575) `def description_for(self, kind)` - *Return the gallery description for a diagram kind.
...
- `publish` (line 2589) `def publish(self, maps, project_name, output_dir, stats, renderer)` - *Publish maps and a gallery index into a documentation directory.
...
Returns:
    Mapping of published page identifier to written file path.*
- `render_index` (line 2647) `def render_index(self, project_name, maps, stats, href_prefix)` - *Render the gallery index page for published maps.
...
- `_href_prefix` (line 2744) `def _href_prefix(self)` - *Return the relative href prefix for map links.

Returns:
    Map subdirectory with trailing slash, or empty string.*
- `_card` (line 2755) `def _card(self, kind, system_map, href_prefix)` - *Render one gallery card linking to a published map.
...
- `_stats_line` (line 2791) `def _stats_line(self, stats)` - *Render the gallery header statistics line.
...
- `_escape` (line 2805) `def _escape(self, value)` - *Escape text for HTML embedding.
...
**Classes:**
- `AnalyzerFactory` (line 39) `class AnalyzerFactory` - *Lazy factory for all readmenator analyzer and generator instances.

Decouples the application orchestrator from the concrete
instantiation of analysis modules. Each component is created
on first access and cached for the lifetime of the factory.*
- `DeepAnalysisRunner` (line 248) `class DeepAnalysisRunner` - *Orchestrates the extended V2 analysis pipeline.
...
**Methods:**
- `__init__` (line 47) `def __init__(self, config)`
- `scanner` (line 74) `def scanner(self)`
- `generator` (line 80) `def generator(self)`
- `analyzer` (line 86) `def analyzer(self)`
- `security` (line 92) `def security(self)`
- `exporter` (line 98) `def exporter(self)`
- `taint` (line 104) `def taint(self)`
- `hotspots` (line 110) `def hotspots(self)`
- `layer_rules` (line 116) `def layer_rules(self)`
- `rule_gen` (line 122) `def rule_gen(self)`
- `sarif` (line 128) `def sarif(self)`
- `cpg` (line 134) `def cpg(self)`
- `layer_detector` (line 143) `def layer_detector(self)`
- `uml` (line 149) `def uml(self)`
- `readme_injector` (line 155) `def readme_injector(self)`
- `agent_injector` (line 164) `def agent_injector(self)`
- `agent_output` (line 173) `def agent_output(self)`
- `diagram_builder` (line 179) `def diagram_builder(self)` - *Return the lazily initialised system map builder.*
- `diagram_renderer` (line 186) `def diagram_renderer(self)` - *Return the lazily initialised interactive map renderer.*
- `diagram_validator` (line 193) `def diagram_validator(self)` - *Return the lazily initialised system map validator.*
- `diagram_publisher` (line 200) `def diagram_publisher(self)` - *Return the lazily initialised documentation site publisher.*
- `vis_renderer` (line 207) `def vis_renderer(self)` - *Return the lazily initialised vis.js network renderer.*
- `build_typed_graph` (line 213) `def build_typed_graph(self, nodes, edges, resolved_edges)`
- `make_ranker` (line 223) `def make_ranker(self, typed_graph)` - *Create a CompositeRanker for the given typed graph.*
- `last_category` (line 240) `def last_category(self)`
- `last_typed_graph` (line 244) `def last_typed_graph(self)`
- `__init__` (line 257) `def __init__(self, factory)`
- `run` (line 260) `def run(self, nodes, edges, resolved_edges, layers, content_map)`
...
**Classes:**
- `ReadmeInjector` (line 60) `class ReadmeInjector` - *Injects a link to KNOWLEDGE_BASE.md into the project README.
...
**Methods:**
- `__init__` (line 68) `def __init__(self, kb_filename, agent_output_dir)`
- `inject` (line 76) `def inject(self, project_root)`
- `_extract_current_injection` (line 105) `def _extract_current_injection(content)`
- `_remove_old_injection` (line 114) `def _remove_old_injection(content)`
- `remove` (line 124) `def remove(self, project_root)`
- `_find_readme` (line 153) `def _find_readme(root)`
- `_build_injection` (line 160) `def _build_injection(self, suffix)`
...
**Methods:**
- `__init__` (line 61) `def __init__(self, file_ids, root, extensions)` - *Initialise the resolver with all known file paths.

Args:
    file_ids: List of relative file paths from the scan.
    root: Root directory for relative-path resolution.
    extensions: Known source extensions, defaults to Config.*
- `_build_stem_index` (line 80) `def _build_stem_index(self, file_ids)` - *Map file stems (without extension) to their full paths.*
- `_build_dir_index` (line 90) `def _build_dir_index(self, file_ids)` - *Map directory paths to the files they contain.*
- `resolve` (line 107) `def resolve(self, import_str, source_file)` - *Resolve an import string to a concrete project file path.
...
- `resolve_all` (line 146) `def resolve_all(self, import_str, source_file)` - *Resolve *import_str* to all possible matching project file paths.
...
- `_resolve_relative` (line 162) `def _resolve_relative(self, import_str, source_file)` - *Resolve a relative import (starts with ``.`` or ``..``).*
- `_resolve_verbatim` (line 180) `def _resolve_verbatim(self, import_str, source_file)` - *Resolve a path-like import verbatim against the source directory.

Covers quoted C-family includes such as ``"utils.h"`` or
``"lib/net.h"`` which name a project file relative to the
including file.*
- `_resolve_extensionless` (line 198) `def _resolve_extensionless(self, import_str, source_file)` - *Resolve a bare module name by appending known extensions.*
- `_resolve_directory_init` (line 207) `def _resolve_directory_init(self, import_str, source_file)` - *Resolve as a package directory with __init__ or index file.*
- `_resolve_module_dotpath` (line 217) `def _resolve_module_dotpath(self, import_str)` - *Resolve a dotted module path (Python/Java convention).*
- `_resolve_suffix_match` (line 239) `def _resolve_suffix_match(self, import_str)` - *Match a slash-qualified include against project path suffixes.

Covers include-directory style references such as
``"kernel/mm.h"`` mapping to ``"include/kernel/mm.h"``. Only
unambiguous matches resolve.*
- `_resolve_stem_match` (line 254) `def _resolve_stem_match(self, import_str)` - *Match by file stem only (last resort).*
- `_strip_extension` (line 263) `def _strip_extension(self, name)` - *Remove a trailing known source extension from a file name.
...
- `TestAgentInjectorRemoveBehavior` (line 165) `class TestAgentInjectorRemoveBehavior(TestCase)` - *BDD: AgentInjector removal contract.*
- `TestAgentInjectorFindFiles` (line 208) `class TestAgentInjectorFindFiles(TestCase)` - *BDD: AgentInjector file detection contract.*
- `TestAgentInjectorEdgeCases` (line 245) `class TestAgentInjectorEdgeCases(TestCase)` - *BDD: AgentInjector edge case contract.*
...
- `test_inject_into_cursorrules_adds_kb_link` (line 47) `def test_inject_into_cursorrules_adds_kb_link(self)`
- `test_inject_into_github_copilot_instructions` (line 55) `def test_inject_into_github_copilot_instructions(self)`
- `test_inject_replaces_old_injection_without_regen_command` (line 65) `def test_inject_replaces_old_injection_without_regen_command(self)`
- `test_inject_skips_when_already_up_to_date` (line 80) `def test_inject_skips_when_already_up_to_date(self)`
- `test_inject_into_cursor_rules_mdc_glob` (line 93) `def test_inject_into_cursor_rules_mdc_glob(self)`
- `test_inject_is_idempotent_does_not_duplicate` (line 103) `def test_inject_is_idempotent_does_not_duplicate(self)`
- `test_inject_no_agent_files_returns_zero` (line 114) `def test_inject_no_agent_files_returns_zero(self)`
- `test_inject_preserves_existing_content` (line 118) `def test_inject_preserves_existing_content(self)`
- `test_inject_multiple_agent_files` (line 126) `def test_inject_multiple_agent_files(self)`
- `test_inject_plain_text_format_for_yaml` (line 133) `def test_inject_plain_text_format_for_yaml(self)`
- `test_custom_kb_filename_works` (line 142) `def test_custom_kb_filename_works(self)`
- `test_injection_includes_regeneration_command` (line 150) `def test_injection_includes_regeneration_command(self)`
- `test_inject_does_not_execute_commands` (line 157) `def test_inject_does_not_execute_commands(self)`
- `setUp` (line 168) `def setUp(self)`
- `tearDown` (line 173) `def tearDown(self)`
- `test_remove_strips_injected_section` (line 176) `def test_remove_strips_injected_section(self)`
- `test_remove_without_injection_returns_zero` (line 187) `def test_remove_without_injection_returns_zero(self)`
- `test_remove_no_files_returns_zero` (line 193) `def test_remove_no_files_returns_zero(self)`
- `test_remove_preserves_original_content` (line 197) `def test_remove_preserves_original_content(self)`
- `setUp` (line 211) `def setUp(self)`
- `tearDown` (line 215) `def tearDown(self)`
- `test_finds_agents_md` (line 218) `def test_finds_agents_md(self)`
- `test_finds_all_listed_files` (line 224) `def test_finds_all_listed_files(self)`
- `test_finds_cursor_rules_glob` (line 231) `def test_finds_cursor_rules_glob(self)`
- `test_returns_empty_when_no_files` (line 240) `def test_returns_empty_when_no_files(self)`
- `setUp` (line 248) `def setUp(self)`
- `tearDown` (line 253) `def tearDown(self)`
- `test_inject_into_empty_file` (line 256) `def test_inject_into_empty_file(self)`
- `test_inject_respects_custom_agent_files_list` (line 264) `def test_inject_respects_custom_agent_files_list(self)`
- `test_inject_does_not_touch_unlisted_files` (line 272) `def test_inject_does_not_touch_unlisted_files(self)`
...
- `TestGotchasGeneration` (line 175) `class TestGotchasGeneration(TestCase)`
- `TestArchitectureGeneration` (line 216) `class TestArchitectureGeneration(TestCase)`
- `TestApiGeneration` (line 238) `class TestApiGeneration(TestCase)`
- `TestSubsystemFileGeneration` (line 264) `class TestSubsystemFileGeneration(TestCase)`
- `TestRecipesGeneration` (line 286) `class TestRecipesGeneration(TestCase)`
- `TestFullGenerate` (line 301) `class TestFullGenerate(TestCase)`
- `TestInjectionOutdatedDetection` (line 361) `class TestInjectionOutdatedDetection(TestCase)`
...
- `test_no_json_wrapping` (line 166) `def test_no_json_wrapping(self)`
- `test_god_nodes_section` (line 176) `def test_god_nodes_section(self)`
- `test_cycles_section` (line 192) `def test_cycles_section(self)`
- `test_empty_gotchas` (line 209) `def test_empty_gotchas(self)`
- `test_internal_dependencies` (line 217) `def test_internal_dependencies(self)`
- `test_external_imports` (line 228) `def test_external_imports(self)`
- `test_functions_listed` (line 239) `def test_functions_listed(self)`
- `test_no_json_in_api` (line 253) `def test_no_json_in_api(self)`
- `test_subsystem_files_written` (line 265) `def test_subsystem_files_written(self)`
- `test_recipes_directory` (line 287) `def test_recipes_directory(self)`
- `test_generate_creates_all_files` (line 302) `def test_generate_creates_all_files(self)`
- `test_all_files_under_500_lines` (line 333) `def test_all_files_under_500_lines(self)`
- `test_no_json_in_any_output` (line 348) `def test_no_json_in_any_output(self)`
- `test_agent_injector_detects_outdated` (line 362) `def test_agent_injector_detects_outdated(self)`
- `test_agent_injector_skips_identical` (line 384) `def test_agent_injector_skips_identical(self)`
- `test_readme_injector_detects_outdated` (line 400) `def test_readme_injector_detects_outdated(self)`
- `test_readme_injector_skips_identical` (line 422) `def test_readme_injector_skips_identical(self)`
...
- `TestParserFactoryContract` (line 467) `class TestParserFactoryContract(TestCase)`
...
- `test_extracts_includes` (line 459) `def test_extracts_includes(self)`
- `setUp` (line 468) `def setUp(self)`
- `test_returns_c_parser_for_c_extensions` (line 471) `def test_returns_c_parser_for_c_extensions(self)`
- `test_returns_python_parser_for_py` (line 477) `def test_returns_python_parser_for_py(self)`
- `test_returns_none_for_unknown_extension` (line 482) `def test_returns_none_for_unknown_extension(self)`
- `test_returns_rust_parser_for_rs` (line 486) `def test_returns_rust_parser_for_rs(self)`
- `test_case_insensitive_extension` (line 491) `def test_case_insensitive_extension(self)`
