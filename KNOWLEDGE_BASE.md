...
**Total Files Parsed:** 100 | **Total Symbols Extracted:** 1265 | **Total Imports:** 569
 | **Resolved Imports:** 270

<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:83b1dff | date:2026-07-18 -->
...
| Total Imports | 569 |
| Call Edges | 6401 |
| Inheritance Edges | 96 |
| Languages | 2 |
| Avg Symbols/File | 12.7 |
...
- `_agent_injector.py` (py, 11 symbols)
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3344 | 0.3658 | 0.3490 | 0.00 | 1.00 |
| 2 | `_category.py` | 0.2559 | 0.3289 | 0.3089 | 0.00 | 0.46 |
| 3 | `_config.py` | 0.1344 | 0.0502 | 0.0589 | 0.00 | 1.00 |
| 4 | `_layers.py` | 0.1056 | 0.0100 | 0.0056 | 0.00 | 1.00 |
| 5 | `_rule_gen.py` | 0.1054 | 0.0353 | 0.0032 | 0.00 | 0.89 |
| 6 | `_base.py` | 0.1049 | 0.0000 | 0.0243 | 0.00 | 1.00 |
| 7 | `_resolver.py` | 0.1010 | 0.0000 | 0.0052 | 0.00 | 1.00 |
...
**Query anchors:** tests/test_rule_gen.py, readmenator/_documentation.py, tests/test_linter.py, readmenator/_linter.py, tests/test_ranking.py, readmenator/_rule_gen.py, tests/test_documentation.py

**Top result justification paths:**

  `test_rule_gen.py -> _models.py`
  `test_rule_gen.py -> _rule_gen.py -> _models.py`
...
### readmenator (Cohesion: 0.85)

**61 files** in this community:
...
- How are the 61 files in 'readmenator' related to each other?
...
**Taint Sources:** 1 | **Taint Sinks:** 32 | **Propagation Paths:** 20
...
- `_agent_injector.py` imports `subprocess` (5 hops to `_category.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _rank.py -> ...
- `_agent_injector.py` imports `subprocess` (5 hops to `_agent_injector.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _pipeline.py -> ...
...
| `_config.py` | 0.012 | 0.671 | 0.407 | 1 | 53 |
...
| `_dart.py` | 2 | 15 | 17 |
| `_elixir.py` | 2 | 15 | 17 |
| `_gdscript.py` | 2 | 15 | 17 |
| `_go.py` | 2 | 15 | 17 |
| `_java.py` | 2 | 15 | 17 |
| `_javascript.py` | 2 | 15 | 17 |
| `_kotlin.py` | 2 | 15 | 17 |
| `_lua.py` | 2 | 15 | 17 |
| `_nim.py` | 2 | 15 | 17 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 1092 total | py | 1092 |
...
graph TD
    ...
    subgraph community_2 ["readmenator/parsers"]
...
classDiagram
  class _agent_injector_py_AgentInjector {
    ...
    +__init__(self, kb_filename, agent_files, agent_globs)
...
- `_run_tests` (line 99) `def _run_tests()`
...
**Classes:**
- `AgentInjector` (line 111) `class AgentInjector` - *Injects a link to KNOWLEDGE_BASE.md into AI agent instruction files.
...
**Functions:**
- `ensure_readmenator_installed` (line 86) `def ensure_readmenator_installed()` - *Check if readmenator is installed via pip; install it if missing.

Returns True if readmenator is available after the check.*

**Methods:**
- `__init__` (line 122) `def __init__(self, kb_filename, agent_files, agent_globs)`
- `inject` (line 132) `def inject(self, project_root)` - *Inject KB reference into all discovered agent files.

Returns the number of agent files actually modified.*
- `remove` (line 150) `def remove(self, project_root)` - *Remove KB injection from all discovered agent files.

Returns the number of files actually modified.*
- `find_agent_files` (line 163) `def find_agent_files(self, project_root)` - *Public accessor: return all detected agent files.*
- `_find_agent_files` (line 167) `def _find_agent_files(self, root)`
- `_inject_single` (line 181) `def _inject_single(self, path)`
- `_remove_old_injection` (line 205) `def _remove_old_injection(content)`
- `_remove_single` (line 215) `def _remove_single(self, path)`
- `_build_injection` (line 231) `def _build_injection(self, fmt)`
...
- `_write_sidecar_outputs` (line 175) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_inject_readme_link` (line 201) `def _inject_readme_link(self, root)`
- `_inject_agent_files` (line 209) `def _inject_agent_files(self, root)`
- `generate_uml_code` (line 217) `def generate_uml_code(self, target_dir, language, output_path)`
- `_log_summary` (line 229) `def _log_summary(self, nodes, edges, root, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 284) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 373) `def _scan_for_cache(self, root, cache)`
- `query` (line 391) `def query(self, target_dir, question)`
- `explain` (line 396) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 408) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 421) `def summary(self, target_dir)`
- `rank_query` (line 426) `def rank_query(self, target_dir, query, top_n)` - *Run a ranked query against the knowledge graph.
...
- `rebuild` (line 456) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 459) `def analyze(self, target_dir)`
- `export_json` (line 463) `def export_json(self, target_dir, output_path)`
- `export_html` (line 474) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 485) `def export_svg(self, target_dir, output_path)`
- `export` (line 496) `def export(self, target_dir)`
- `export_graphml` (line 501) `def export_graphml(self, target_dir, output_path)`
- `export_cypher` (line 512) `def export_cypher(self, target_dir, output_path)`
- `export_obsidian` (line 525) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 535) `def watch(self, target_dir)`
- `audit` (line 545) `def audit(self, target_dir)`
- `audit_deep` (line 552) `def audit_deep(self, target_dir)`
- `export_sarif` (line 572) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 582) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 592) `def detect_layers(self, target_dir)`
- `lint` (line 602) `def lint(self, target_dir)`
- `strip_dead_code` (line 615) `def strip_dead_code(self, target_dir)`
- `generate_cursorrules` (line 625) `def generate_cursorrules(self, target_dir)`
- `refactor_monolith` (line 640) `def refactor_monolith(self, target_dir)`
- `on_change` (line 539) `def on_change()`
...
**Classes:**
- `AnalyzerFactory` (line 37) `class AnalyzerFactory` - *Lazy factory for all readmenator analyzer and generator instances.

Decouples the application orchestrator from the concrete
instantiation of analysis modules. Each component is created
on first access and cached for the lifetime of the factory.*
- `DeepAnalysisRunner` (line 197) `class DeepAnalysisRunner` - *Orchestrates the extended V2 analysis pipeline.
...
- `scanner` (line 66) `def scanner(self)`
- `generator` (line 72) `def generator(self)`
- `analyzer` (line 78) `def analyzer(self)`
- `security` (line 84) `def security(self)`
- `exporter` (line 90) `def exporter(self)`
- `taint` (line 96) `def taint(self)`
- `hotspots` (line 102) `def hotspots(self)`
- `layer_rules` (line 108) `def layer_rules(self)`
- `rule_gen` (line 114) `def rule_gen(self)`
- `sarif` (line 120) `def sarif(self)`
- `cpg` (line 126) `def cpg(self)`
- `layer_detector` (line 135) `def layer_detector(self)`
- `uml` (line 141) `def uml(self)`
- `readme_injector` (line 147) `def readme_injector(self)`
- `agent_injector` (line 155) `def agent_injector(self)`
- `build_typed_graph` (line 162) `def build_typed_graph(self, nodes, edges, resolved_edges)`
- `make_ranker` (line 172) `def make_ranker(self, typed_graph)` - *Create a CompositeRanker for the given typed graph.*
- `last_category` (line 189) `def last_category(self)`
- `last_typed_graph` (line 193) `def last_typed_graph(self)`
- `__init__` (line 206) `def __init__(self, factory)`
- `run` (line 209) `def run(self, nodes, edges, resolved_edges, layers, content_map)`
