...
**Total Files Parsed:** 47 | **Total Symbols Extracted:** 713 | **Total Imports:** 271
 | **Resolved Imports:** 113
...
- What does _config.py depend on, and what depends on it? (36 connections)
- What does _models.py depend on, and what depends on it? (32 connections)
- What does _pipeline.py depend on, and what depends on it? (15 connections)
- How are the 43 files in 'readmenator' related to each other?
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.179 | 0.925 | 0.626 | 15 | 37 |
| `_config.py` | 0.012 | 1.000 | 0.605 | 1 | 40 |
| `_pipeline.py` | 0.202 | 0.775 | 0.546 | 17 | 31 |
| `test_parsers.py` | 1.000 | 0.150 | 0.490 | 84 | 6 |
| `_app.py` | 0.345 | 0.550 | 0.468 | 29 | 22 |
| `test_security.py` | 0.750 | 0.275 | 0.465 | 63 | 11 |
| `_parsers.py` | 0.536 | 0.300 | 0.394 | 45 | 12 |
| `readmenator_orchestrator.py` | 0.357 | 0.300 | 0.323 | 30 | 12 |
| `test_documentation.py` | 0.286 | 0.300 | 0.294 | 24 | 12 |
| `_security.py` | 0.321 | 0.275 | 0.294 | 27 | 11 |
| `_documentation.py` | 0.238 | 0.325 | 0.290 | 20 | 13 |
| `_exporter.py` | 0.167 | 0.350 | 0.277 | 14 | 14 |
| `test_parsers_new.py` | 0.429 | 0.150 | 0.261 | 36 | 6 |
| `test_scanner.py` | 0.202 | 0.300 | 0.261 | 17 | 12 |
| `_scanner.py` | 0.155 | 0.300 | 0.242 | 13 | 12 |
...
| `_mermaid.py` | 2 | 7 | 9 |
| `_analyzer.py` | 2 | 5 | 7 |
| `_documentation.py` | 2 | 5 | 7 |
| `_exporter.py` | 2 | 5 | 7 |
| `_hotspots.py` | 2 | 5 | 7 |
| `_layer_rules.py` | 2 | 5 | 7 |
| `_rule_gen.py` | 2 | 5 | 7 |
| `_sarif.py` | 2 | 5 | 7 |
| `_scanner.py` | 2 | 5 | 7 |
| `_security.py` | 2 | 5 | 7 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 604 total | py | 604 |
...
**Classes:**
- `readmenatorApplication` (line 21) `class readmenatorApplication` - *High-level facade for readmenator operations.
...
- `_scan` (line 39) `def _scan(self, target_dir)`
- `_scan_with_content` (line 47) `def _scan_with_content(self, target_dir)`
- `_resolve_imports` (line 57) `def _resolve_imports(self, nodes, edges, target_dir)`
- `run` (line 76) `def run(self, target_dir, resolve_imports, run_analysis, run_security, run_v2_analysis)`
- `_write_sidecar_outputs` (line 134) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_print_summary` (line 158) `def _print_summary(self, nodes, edges, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 204) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 234) `def _scan_for_cache(self, root, cache)`
- `query` (line 252) `def query(self, target_dir, question)`
- `explain` (line 257) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 269) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 282) `def summary(self, target_dir)`
- `rebuild` (line 287) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 290) `def analyze(self, target_dir)`
- `export_json` (line 296) `def export_json(self, target_dir, output_path)`
- `export_html` (line 315) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 334) `def export_svg(self, target_dir, output_path)`
- `export` (line 353) `def export(self, target_dir)`
- `export_graphml` (line 358) `def export_graphml(self, target_dir, output_path)`
- `export_obsidian` (line 377) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 395) `def watch(self, target_dir)`
- `audit` (line 406) `def audit(self, target_dir)`
- `audit_deep` (line 413) `def audit_deep(self, target_dir)`
- `export_sarif` (line 434) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 448) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 462) `def detect_layers(self, target_dir)`
- `on_change` (line 400) `def on_change()`
