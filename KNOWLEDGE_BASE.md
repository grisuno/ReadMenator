...
> Generated offline by **readmenator**. 108 files, 1661 symbols, 692 imports. Supports C, C++, Python, Go, Rust, JS/TS, Java, C#, Shell, PHP, Dart, GDScript, Nim, ASM, Ruby, Swift, Kotlin, Scala, Lua, Elixir.
...
**Total Files Parsed:** 108 | **Total Symbols Extracted:** 1661 | **Total Imports:** 692
...
| Total Imports | 692 |
| Call Edges | 9400 |
| Inheritance Edges | 117 |
| Languages | 2 |
| Avg Symbols/File | 15.4 |
| Avg Imports/File | 6.4 |
| Resolved Imports | 314 |
...
| `_pipeline.py` | 25 | 32 | py |
| `__init__.py` | 23 | 2 | py |
| `_app.py` | 19 | 44 | py |
| `readmenator_orchestrator.py` | 14 | 34 | py |
| `_wiki.py` | 13 | 34 | py |
| `test_wiki.py` | 12 | 30 | py |
| `_agent_output.py` | 11 | 18 | py |
...
- `_agent_output.py` (py, 18 symbols)
- `_analyzer.py` (py, 14 symbols)
- `_app.py` (py, 44 symbols)
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3349 | 0.3569 | 0.3467 | 0.00 | 1.05 |
| 2 | `_category.py` | 0.2537 | 0.3167 | 0.3060 | 0.00 | 0.50 |
| 3 | `_config.py` | 0.2380 | 0.0569 | 0.0621 | 0.00 | 2.00 |
| 4 | `_layers.py` | 0.1295 | 0.0075 | 0.0054 | 0.00 | 1.25 |
| 5 | `_watcher.py` | 0.1205 | 0.0000 | 0.0026 | 0.00 | 1.20 |
| 6 | `_diagrams.py` | 0.1113 | 0.0202 | 0.0035 | 0.00 | 1.01 |
| 7 | `_scanner.py` | 0.1083 | 0.0000 | 0.0032 | 0.00 | 1.08 |
| 8 | `_analyzer.py` | 0.1079 | 0.0000 | 0.0038 | 0.00 | 1.07 |
| 9 | `_resolver.py` | 0.1072 | 0.0000 | 0.0048 | 0.00 | 1.06 |
| 10 | `_query.py` | 0.1068 | 0.0002 | 0.0044 | 0.00 | 1.06 |

**Query anchors:** tests/test_documentation.py, tests/test_rule_gen.py, readmenator/_diagrams.py, readmenator/_documentation.py, tests/test_linter.py, readmenator/_agent_output.py, readmenator/_rule_gen.py, tests/test_ranking.py (+2 more)

**Top result justification paths:**

  `test_documentation.py -> _documentation.py -> _cpg.py -> _models.py`
  `test_documentation.py -> _documentation.py -> _mermaid.py -> _models.py`
...
|------|-------|-------------|----------|
| `_models.py` | 152.0 | | 0.3467 |
| `_config.py` | 112.1 | | 0.0621 |
| `_pipeline.py` | 51.2 | | 0.0000 |
| `__init__.py` | 48.2 | | 0.0000 |
| `_base.py` | 44.6 | | 0.0000 |
| `_app.py` | 44.4 | | 0.0000 |
| `test_parsers_property.py` | 42.7 | | 0.0000 |
| `_mcp_server.py` | 21.2 | | 0.0000 |
| `_documentation.py` | 18.8 | | 0.0000 |
| `_diagrams.py` | 18.7 | | 0.0035 |
...
- `test_agent_injector.py` <-> `test_resolver.py` (5 hops, across 2 communities)
- `__init__.py` <-> `test_agent_injector.py` (4 hops, across 2 communities)
- `_agent_injector.py` <-> `test_resolver.py` (4 hops, across 2 communities)
- `_cache.py` <-> `test_agent_injector.py` (4 hops, across 2 communities)
- `_cursorrules_generator.py` <-> `test_agent_injector.py` (4 hops, across 2 communities)
...
- What does _models.py depend on, and what depends on it? (75 connections)
- What does _config.py depend on, and what depends on it? (56 connections)
- What does _pipeline.py depend on, and what depends on it? (24 connections)
- How are the 93 files in 'readmenator' related to each other?
- Why are test_agent_injector.py and test_resolver.py connected through 5 hops across 2 communities?
...
**Taint Sources:** 1 | **Taint Sinks:** 36 | **Propagation Paths:** 20

- `_agent_injector.py` imports `subprocess` (0 hop to `_agent_injector.py`) [high]
  Path: _agent_injector.py
- `_agent_injector.py` imports `subprocess` (1 hop to `readmenator.py`) [high]
  Path: _agent_injector.py -> readmenator.py
- `_agent_injector.py` imports `subprocess` (2 hops to `__main__.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py
- `_agent_injector.py` imports `subprocess` (3 hops to `_app.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py
- `_agent_injector.py` imports `subprocess` (3 hops to `_config.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _config.py
- `_agent_injector.py` imports `subprocess` (3 hops to `_mcp_server.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_cursorrules_generator.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _cursorrules_generator.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_models.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _models.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_layers.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _layers.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_diagrams.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _diagrams.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_pipeline.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _pipeline.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_query.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _query.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_resolver.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _resolver.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_rank.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _rank.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_watcher.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _watcher.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_refactorizer.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _refactorizer.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_dead_code.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _dead_code.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_linter.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _linter.py
- `_agent_injector.py` imports `subprocess` (4 hops to `_cache.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _cache.py
- `_agent_injector.py` imports `subprocess` (5 hops to `_category.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _models.py -> ...
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.230 | 1.000 | 0.692 | 20 | 93 |
| `_category.py` | 0.299 | 0.150 | 0.210 | 26 | 14 |
| `_config.py` | 0.011 | 0.634 | 0.385 | 1 | 59 |
| `_layers.py` | 0.046 | 0.097 | 0.076 | 4 | 9 |
| `_watcher.py` | 0.058 | 0.097 | 0.081 | 5 | 9 |
| `_diagrams.py` | 0.770 | 0.161 | 0.405 | 67 | 15 |
| `_scanner.py` | 0.149 | 0.150 | 0.150 | 13 | 14 |
| `_analyzer.py` | 0.161 | 0.140 | 0.148 | 14 | 13 |
| `_resolver.py` | 0.184 | 0.107 | 0.138 | 16 | 10 |
| `_query.py` | 0.195 | 0.129 | 0.156 | 17 | 12 |
| `test_diagrams.py` | 0.793 | 0.387 | 0.549 | 69 | 36 |
| `_pipeline.py` | 0.368 | 0.527 | 0.463 | 32 | 49 |
| `_app.py` | 0.506 | 0.430 | 0.460 | 44 | 40 |
| `test_agent_output.py` | 0.517 | 0.398 | 0.446 | 45 | 37 |
| `test_parsers.py` | 1.000 | 0.065 | 0.439 | 87 | 6 |
...
| Cycle | Length | Files |
|-------|--------|-------|
| `_app.py -> _pipeline.py -> _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py -> _app.py` | 6 | 6 |
| `_app.py -> _pipeline.py -> _agent_injector.py -> readmenator.py -> __main__.py -> _app.py` | 5 | 5 |
| `_models.py -> _category.py -> _models.py` | 2 | 2 |
...
| `_dart.py` | 2 | 17 | 19 |
| `_elixir.py` | 2 | 17 | 19 |
| `_gdscript.py` | 2 | 17 | 19 |
| `_go.py` | 2 | 17 | 19 |
| `_java.py` | 2 | 17 | 19 |
| `_javascript.py` | 2 | 17 | 19 |
| `_kotlin.py` | 2 | 17 | 19 |
| `_lua.py` | 2 | 17 | 19 |
| `_nim.py` | 2 | 17 | 19 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 1449 total | py | 1449 |
...
graph TD
    ...
    readmenator__agent_injector_py -- resolved_imports --> readmenator_py
    ...
    ext_readmenator["readmenator"]
    class ext_readmenator ext;
    readmenator__agent_injector_py -.->|imports| ext_readmenator
...
classDiagram
  ...
  class _agent_output_py_AgentOutputGenerator {
    ...
    +_build_index(self, nodes, subsystems)
    +_build_architecture(self, edges, resolved_edges, nodes)
    +_build_security(self, findings, nodes)
    +_enclosing_symbol(nodes, file_path, line)
    +_build_api(self, nodes, resolved_map, imported_by)
    +_build_manifest(self, nodes, edges, resolved_edges, findings, project_root)
    +_build_symbols(self, nodes)
  }
  ...
  class _app_py_readmenatorApplication {
    ...
    +_inject_agent_files(self, root)
    +generate_uml_code(self, target_dir, language, output_path)
    +_log_summary(self, nodes, edges, root, resolved_edges, analysis, layer_summary, analysis_v2, findings)
  }
  ...
  class _diagrams_py_MapNode {
    ...
    +build(self, nodes, edges, resolved_edges, layers, findings, analysis, kind)
    +build_all(self, nodes, edges, resolved_edges, layers, findings, analysis)
...
- `_run_tests` (line 107) `def _run_tests()`
- `main` (line 122) `def main()`
...
**Classes:**
- `AgentInjector` (line 136) `class AgentInjector` - *Injects a link to KNOWLEDGE_BASE.md into AI agent instruction files.
...
**Functions:**
- `ensure_readmenator_installed` (line 111) `def ensure_readmenator_installed()` - *Check if readmenator is installed via pip; install it if missing.

Returns True if readmenator is available after the check.*

**Methods:**
- `__init__` (line 147) `def __init__(self, kb_filename, agent_output_dir, agent_files, agent_globs, wiki_output_dir)`
- `inject` (line 161) `def inject(self, project_root)` - *Inject KB reference into all discovered agent files.

Returns the number of agent files actually modified.*
- `remove` (line 179) `def remove(self, project_root)` - *Remove KB injection from all discovered agent files.

Returns the number of files actually modified.*
- `find_agent_files` (line 192) `def find_agent_files(self, project_root)` - *Public accessor: return all detected agent files.*
- `_find_agent_files` (line 196) `def _find_agent_files(self, root)`
- `_inject_single` (line 210) `def _inject_single(self, path)`
- `_extract_current_injection` (line 248) `def _extract_current_injection(content)`
- `_remove_old_injection` (line 257) `def _remove_old_injection(content)`
- `_remove_single` (line 267) `def _remove_single(self, path)`
- `_build_injection` (line 283) `def _build_injection(self, fmt)`
- `_build_mdc_injection` (line 295) `def _build_mdc_injection(self)` - *Build Cursor .mdc injection body (frontmatter added separately).*
- `_prepend_mdc_frontmatter` (line 300) `def _prepend_mdc_frontmatter(content, injection)` - *Prepend Cursor frontmatter so the rule is auto-attached.*

#### `_agent_output.py`
**Path:** `readmenator/_agent_output.py`
**File Doc:** *Agent-friendly output generator for ReadMenator.  Generates grep-optimized, flat-markdown files in a dedicated output directory.  File names for per-subsystem files are **inferred** from the project's directory structure, never hardcoded.  The generated files are designed to be consumed by AI agents that perform ``grep`` / ``read`` operations and need queryable, small-context documents.  Output layout::  readmenator-agent/ ├── INDEX.md              # file -> purpose map (1 page) ├── ARCHITECTURE.md       # dependency pairs (flat list) ├── SECURITY.md           # findings by severity ├── API.md                # public functions + contracts ├── GOTCHAS.md            # "don't change X because Y" ├── recipes/ │   └── *.md              # actionable task blocks └── KB_<subsystem>.md     # 1 file per inferred subsystem*

**Classes:**
- `AgentOutputGenerator` (line 47) `class AgentOutputGenerator` - *Generates agent-friendly, grep-optimised output files.

All output is plain Markdown -- no JSON wrapping, no fenced code
blocks around data structures.  Every line is greppable.*

**Methods:**
- `__init__` (line 54) `def __init__(self, config)`
- `generate` (line 61) `def generate(self, nodes, edges, resolved_edges, analysis, analysis_v2, findings, layers, project_root)` - *Write all agent output files and return the output directory path.*
- `_infer_subsystems` (line 116) `def _infer_subsystems(self, nodes)` - *Group nodes by directory, inferring subsystem names.*
- `_build_index` (line 153) `def _build_index(self, nodes, subsystems)`
- `_build_architecture` (line 183) `def _build_architecture(self, edges, resolved_edges, nodes)`
- `_build_security` (line 227) `def _build_security(self, findings, nodes)`
- `_enclosing_symbol` (line 257) `def _enclosing_symbol(nodes, file_path, line)` - *Return the nearest symbol defined at or before line in file_path.*
- `_build_api` (line 276) `def _build_api(self, nodes, resolved_map, imported_by)`
- `_build_manifest` (line 331) `def _build_manifest(self, nodes, edges, resolved_edges, findings, project_root)` - *Build MANIFEST.json with freshness + entry points for agents.*
- `_build_symbols` (line 370) `def _build_symbols(self, nodes)` - *Build grep-friendly symbol index (one line per symbol).*
- `_build_gotchas` (line 387) `def _build_gotchas(self, analysis, analysis_v2, nodes)`
- `_write_subsystem_files` (line 469) `def _write_subsystem_files(self, out_dir, subsystems, resolved_map, imported_by, layers)`
- `_build_subsystem_content` (line 488) `def _build_subsystem_content(self, name, file_nodes, resolved_map, imported_by, layers)`
- `_write_recipes` (line 538) `def _write_recipes(self, recipes_dir, analysis, analysis_v2, findings)`
- `_build_resolved_map` (line 637) `def _build_resolved_map(resolved_edges)`
- `_build_imported_by_map` (line 646) `def _build_imported_by_map(resolved_edges)`
- `_write` (line 655) `def _write(path, content)`
...
**Classes:**
- `GraphAnalyzer` (line 39) `class GraphAnalyzer` - *Deterministic graph analysis over scanned nodes and edges.
...
**Functions:**
- `dominant_directory` (line 21) `def dominant_directory(file_ids)` - *Return the most informative directory label for a set of files.
...
**Methods:**
- `__init__` (line 47) `def __init__(self, config)` - *Initialise with application configuration.

Args:
    config: Settings for thresholds and limits.*
- `analyze` (line 55) `def analyze(self, nodes, edges, resolved_edges)` - *Run the full analysis pipeline and return structured results.
...
- `_build_adjacency` (line 108) `def _build_adjacency(self, nodes, edges)` - *Build an undirected adjacency map from import edges.*
- `_build_reverse_adjacency` (line 122) `def _build_reverse_adjacency(self, adjacency)` - *Build a directed reverse adjacency (incoming edges) map.*
- `_compute_god_nodes` (line 132) `def _compute_god_nodes(self, nodes, adjacency, reverse_adjacency)` - *Compute the most central nodes using combined degree centrality.

Score is a combination of out-degree (imports), in-degree (imported-by),
and symbol count. Higher score means more architecturally significant.*
- `_detect_communities` (line 154) `def _detect_communities(self, nodes, adjacency)` - *Detect communities using label propagation.

Each node adopts the most frequent community label among its
neighbors. Iterates until convergence or max iterations reached.
Simple, deterministic, and correct for connected graphs.*
- `_label_communities` (line 209) `def _label_communities(self, nodes, communities)` - *Generate human-readable labels for communities.

Labels are based on the most common directory within the community.*
- `_build_community_map` (line 226) `def _build_community_map(self, communities)` - *Build a reverse map from file ID to community ID.*
- `_compute_cohesion` (line 236) `def _compute_cohesion(self, communities, adjacency)` - *Compute cohesion score for each community.

Cohesion = internal edges / (internal edges + external edges).*
- `_find_surprising_connections` (line 261) `def _find_surprising_connections(self, nodes, adjacency, community_map)` - *Find non-obvious cross-community bridges.

A connection is surprising when two nodes in different communities
are connected indirectly through 3 or more hops, and the path
crosses community boundaries.*
- `_shortest_path_communities` (line 301) `def _shortest_path_communities(self, source, target, adjacency, community_map)` - *Find the shortest path and communities traversed.*
- `_suggest_questions` (line 328) `def _suggest_questions(self, nodes, god_nodes, communities, community_labels, surprising, adjacency)` - *Generate plain-language exploration questions from graph structure.*

#### `_app.py`
**Path:** `readmenator/_app.py`

**Classes:**
- `readmenatorApplication` (line 35) `class readmenatorApplication`

**Methods:**
- `__init__` (line 36) `def __init__(self, config)`
- `_scan` (line 45) `def _scan(self, target_dir)`
- `_scan_with_content` (line 53) `def _scan_with_content(self, target_dir)`
- `_resolve_imports` (line 63) `def _resolve_imports(self, nodes, edges, target_dir)`
- `run` (line 82) `def run(self, target_dir, resolve_imports, run_analysis, run_security, run_v2_analysis)`
- `_write_sidecar_outputs` (line 199) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_inject_readme_link` (line 225) `def _inject_readme_link(self, root)`
- `_inject_agent_files` (line 233) `def _inject_agent_files(self, root)`
- `generate_uml_code` (line 241) `def generate_uml_code(self, target_dir, language, output_path)`
- `_log_summary` (line 253) `def _log_summary(self, nodes, edges, root, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 308) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 413) `def _scan_for_cache(self, root, cache)`
- `query` (line 431) `def query(self, target_dir, question)`
- `explain` (line 436) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 448) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 461) `def summary(self, target_dir)`
- `rank_query` (line 466) `def rank_query(self, target_dir, query, top_n)` - *Run a ranked query against the knowledge graph.
...
- `rebuild` (line 496) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 499) `def analyze(self, target_dir)`
- `export_json` (line 503) `def export_json(self, target_dir, output_path)`
- `export_html` (line 514) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 525) `def export_svg(self, target_dir, output_path)`
- `export` (line 536) `def export(self, target_dir)`
- `export_graphml` (line 541) `def export_graphml(self, target_dir, output_path)`
- `export_cypher` (line 552) `def export_cypher(self, target_dir, output_path)`
- `export_obsidian` (line 565) `def export_obsidian(self, target_dir, output_dir)`
- `export_wiki` (line 575) `def export_wiki(self, target_dir, output_dir)` - *Generate the navigable agent wiki for the target project.
...
- `lint_wiki` (line 598) `def lint_wiki(self, target_dir)` - *Check wiki health and log reported issues.
...
- `export_diagrams` (line 616) `def export_diagrams(self, target_dir, output_dir)` - *Export all five interactive system maps plus a gallery index.
...
- `_live_renderer` (line 655) `def _live_renderer(self)` - *Return the configured map renderer for published output.

Returns:
    The vis.js renderer when enabled, else the offline renderer.*
- `export_diagram` (line 665) `def export_diagram(self, target_dir, kind, output_path)` - *Export a single interactive system map as standalone HTML.
...
- `export_pages` (line 702) `def export_pages(self, target_dir, output_dir)` - *Publish all system maps plus a gallery index as a static site.
...
- `watch` (line 738) `def watch(self, target_dir)`
- `audit` (line 748) `def audit(self, target_dir)`
- `audit_deep` (line 755) `def audit_deep(self, target_dir)`
- `export_sarif` (line 775) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 785) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 795) `def detect_layers(self, target_dir)`
- `lint` (line 805) `def lint(self, target_dir)`
- `strip_dead_code` (line 818) `def strip_dead_code(self, target_dir)`
- `generate_cursorrules` (line 828) `def generate_cursorrules(self, target_dir)`
- `refactor_monolith` (line 843) `def refactor_monolith(self, target_dir)`
- `on_change` (line 742) `def on_change()`
...
- `SystemMapBuilder` (line 403) `class SystemMapBuilder` - *Builds deterministic system maps from the scanned knowledge graph.*
- `InteractiveMapRenderer` (line 1338) `class InteractiveMapRenderer` - *Renders a system map as one self-contained interactive HTML document.*
- `VisNetworkRenderer` (line 2031) `class VisNetworkRenderer` - *Renders a system map as a physics-driven vis.js network document.

Fetches the configured vis-network bundle from a CDN at view time,
so pages need network access. Nodes stay draggable with live
physics; use the inline renderer when fully offline output matters.*
- `DocsSitePublisher` (line 2552) `class DocsSitePublisher` - *Publishes validated system maps as a static documentation site.
...
- `validate` (line 213) `def validate(self, system_map)` - *Validate a system map and return a deterministic receipt.
...
- `__init__` (line 432) `def __init__(self, config)` - *Initialise the builder with application configuration.

Args:
    config: Central settings for layout geometry and limits.*
- `supported_kinds` (line 441) `def supported_kinds(self)` - *Return the supported diagram kind identifiers.

Returns:
    Ordered list of the configured diagram kinds.*
- `build` (line 449) `def build(self, nodes, edges, resolved_edges, layers, findings, analysis, kind)` - *Build one deterministic system map of the requested kind.
...
- `build_all` (line 484) `def build_all(self, nodes, edges, resolved_edges, layers, findings, analysis)` - *Build all five diagram kinds deterministically.
...
- `compare` (line 513) `def compare(self, base, head)` - *Compare two maps of the same kind as before, delta, and after.
...
- `_title_for` (line 552) `def _title_for(self, kind)` - *Return the display title for a diagram kind.
...
- `_role_for` (line 566) `def _role_for(self, group, sensitive)` - *Return the semantic role for a group with sensitivity override.
...
- `_sensitive_files` (line 583) `def _sensitive_files(self, findings)` - *Return files carrying elevated severity findings.
...
- `_ranked_file_ids` (line 600) `def _ranked_file_ids(self, nodes, links, analysis)` - *Rank file identifiers by centrality then symbol count.
...
- `_select_primary` (line 635) `def _select_primary(self, nodes, links, analysis)` - *Select the primary node scope honoring the configured limit.
...
- `_internal_links` (line 657) `def _internal_links(self, edges, selected)` - *Filter edges to project-internal links between selected files.
...
- `_symbol_records` (line 677) `def _symbol_records(self, node)` - *Build truncated symbol records for map documentation payloads.
...
- `_short_label` (line 699) `def _short_label(self, value)` - *Shorten a label to the configured readable length.
...
- `_layout_columns` (line 714) `def _layout_columns(self, items, kind)` - *Compute deterministic column lane coordinates for grouped items.
...
- `_lanes_that_fit` (line 760) `def _lanes_that_fit(self, lanes)` - *Drop lowest-priority lanes until columns fit the canvas width.
...
- `_fitted_gap` (line 777) `def _fitted_gap(self, count, item, gap, total, margin)` - *Compress spacing deterministically so items fit the canvas.
...
- `_lane_capacity` (line 801) `def _lane_capacity(self)` - *Return the maximum members per lane fitting the canvas height.

Returns:
    Number of node rows fitting between lane top and margin.*
- `_cap_lane_scope` (line 815) `def _cap_lane_scope(self, ranked, layer_of)` - *Cap ranked nodes per lane so every lane fits the canvas height.
...
- `_layout_sequence` (line 839) `def _layout_sequence(self, ordered)` - *Compute deterministic lifeline row coordinates for sequences.
...
Returns:
    Mapping of identifier to canvas coordinates.*
- `_sequence_capacity` (line 860) `def _sequence_capacity(self)` - *Return the maximum participants fitting the canvas width.

Returns:
    Number of lifelines fitting with minimum spacing applied.*
- `_place` (line 874) `def _place(self, ranked, layer_of, kind)` - *Cap lane scope and compute coordinates for placed nodes only.
...
- `_make_views` (line 893) `def _make_views(self, kind, primary, links)` - *Create guided chapters from authored topology.
...
- `_build_architecture` (line 965) `def _build_architecture(self, nodes, links, layers, findings, analysis)` - *Build the runtime architecture map from file topology.
...
- `_build_workflow` (line 1023) `def _build_workflow(self, nodes, links, layers, findings)` - *Build the delivery workflow map across architectural lanes.
...
Returns:
    Workflow system map.*
- `_build_sequence` (line 1096) `def _build_sequence(self, nodes, links, layers, analysis)` - *Build the request sequence map over top participants.
...
Returns:
    Sequence system map.*
- `_build_dataflow` (line 1167) `def _build_dataflow(self, nodes, links, layers, findings)` - *Build the data flow map from sources through stores.
...
Returns:
    Dataflow system map.*
- `_build_lifecycle` (line 1248) `def _build_lifecycle(self, nodes, links, layers, findings)` - *Build the change lifecycle map with waits, retries, and terminals.
...
- `__init__` (line 1341) `def __init__(self, config)` - *Initialise the renderer with application configuration.

Args:
    config: Central settings for preset, theme, and share size.*
- `render` (line 1349) `def render(self, system_map)` - *Render a system map as a self-contained HTML document.
...
- `write` (line 1450) `def write(self, system_map, output_path)` - *Render a system map and write it to a relative output path.
...
Returns:
    Rendered HTML document that was written.*
- `_safe_json` (line 1469) `def _safe_json(self, payload)` - *Serialize a payload for safe inline script embedding.
...
Returns:
    JSON text with angle brackets unicode-escaped.*
- `_escape` (line 1480) `def _escape(self, value)` - *Escape text for SVG and HTML embedding.
...
Returns:
    Escaped text safe for markup contexts.*
- `_role_color` (line 1491) `def _role_color(self, role)` - *Return the stroke color for a semantic role.
...
Returns:
    Hex color string for the role.*
- `_edge_path` (line 1502) `def _edge_path(self, x1, y1, x2, y2)` - *Compute a deterministic curved route between two nodes.
...
- `_nodes_svg` (line 1538) `def _nodes_svg(self, system_map)` - *Render authored nodes as inline SVG groups.
...
- `_edges_svg` (line 1586) `def _edges_svg(self, system_map)` - *Render authored relationships as inline SVG paths.
...
- `_template` (line 1633) `def _template(self)` - *Return the self-contained viewer document template.

Returns:
    HTML template with replacement tokens for map content.*
- `__init__` (line 2039) `def __init__(self, config)` - *Initialise the renderer with application configuration.

Args:
    config: Central settings for CDN bundle and physics.*
- `render` (line 2047) `def render(self, system_map)` - *Render a system map as a vis.js network HTML document.
...
- `write` (line 2148) `def write(self, system_map, output_path)` - *Render a vis.js map and write it to a relative output path.
...
Returns:
    Rendered HTML document that was written.*
- `_tooltip` (line 2165) `def _tooltip(self, node)` - *Build a documentation tooltip for a network node.
...
- `_template` (line 2196) `def _template(self)` - *Return the vis.js viewer document template.

Returns:
    HTML template with replacement tokens for map content.*
- `__init__` (line 2569) `def __init__(self, config)` - *Initialise the publisher with application configuration.

Args:
    config: Central settings for pages layout and map limits.*
- `description_for` (line 2579) `def description_for(self, kind)` - *Return the gallery description for a diagram kind.
...
- `publish` (line 2593) `def publish(self, maps, project_name, output_dir, stats, renderer)` - *Publish maps and a gallery index into a documentation directory.
...
Returns:
    Mapping of published page identifier to written file path.*
- `render_index` (line 2651) `def render_index(self, project_name, maps, stats, href_prefix)` - *Render the gallery index page for published maps.
...
- `_href_prefix` (line 2748) `def _href_prefix(self)` - *Return the relative href prefix for map links.

Returns:
    Map subdirectory with trailing slash, or empty string.*
- `_card` (line 2759) `def _card(self, kind, system_map, href_prefix)` - *Render one gallery card linking to a published map.
...
- `_stats_line` (line 2795) `def _stats_line(self, stats)` - *Render the gallery header statistics line.
...
- `_escape` (line 2809) `def _escape(self, value)` - *Escape text for HTML embedding.
...
- `_apply_context_budget` (line 172) `def _apply_context_budget(self, content, nodes, edges, resolved_edges, analysis, analysis_v2, findings)`
- `_build_toc` (line 310) `def _build_toc(self, nodes, analysis, layers, findings, analysis_v2, is_truncated, ranked)`
- `_build_layers` (line 398) `def _build_layers(self, layers, nodes)`
- `_build_dashboard` (line 432) `def _build_dashboard(self, nodes, edges, resolved_edges)`
- `_build_god_nodes` (line 512) `def _build_god_nodes(self, analysis, ranked)`
- `_build_community_analysis` (line 540) `def _build_community_analysis(self, analysis, nodes)`
- `_build_surprising_connections` (line 573) `def _build_surprising_connections(self, analysis, nodes)`
- `_build_suggested_questions` (line 598) `def _build_suggested_questions(self, analysis)`
- `_build_ranked_context` (line 614) `def _build_ranked_context(self, ranked)`
- `_build_orphans` (line 660) `def _build_orphans(self, nodes, analysis_v2, ranked)` - *Build a section listing nodes with low coverage signals.*
- `_build_query_recipes` (line 710) `def _build_query_recipes(self)`
- `_build_taint_analysis` (line 752) `def _build_taint_analysis(self, analysis_v2)`
- `_build_hotspots` (line 787) `def _build_hotspots(self, analysis_v2, ranked)`
- `_build_dataflow_analysis` (line 825) `def _build_dataflow_analysis(self, analysis_v2)` - *Build the procedural dataflow findings section.*
- `_build_dependency_cycles` (line 856) `def _build_dependency_cycles(self, analysis_v2)`
- `_build_change_impact` (line 877) `def _build_change_impact(self, analysis_v2)`
- `_build_layer_violations` (line 902) `def _build_layer_violations(self, analysis_v2)`
- `_build_suggested_rules` (line 930) `def _build_suggested_rules(self, analysis_v2)`
- `_build_security_findings` (line 955) `def _build_security_findings(self, findings)`
- `_build_mermaid_section` (line 1002) `def _build_mermaid_section(self, graph_output, is_truncated)`
- `_build_uml_diagram` (line 1025) `def _build_uml_diagram(self, nodes, edges)`
- `_build_cpg_block` (line 1051) `def _build_cpg_block(self, nodes, edges, resolved_edges, analysis)`
- `_build_architecture_reference` (line 1077) `def _build_architecture_reference(self, nodes, edges)`
...
**Classes:**
- `AnalyzerFactory` (line 41) `class AnalyzerFactory` - *Lazy factory for all readmenator analyzer and generator instances.

Decouples the application orchestrator from the concrete
instantiation of analysis modules. Each component is created
on first access and cached for the lifetime of the factory.*
- `DeepAnalysisRunner` (line 268) `class DeepAnalysisRunner` - *Orchestrates the extended V2 analysis pipeline.
...
**Methods:**
- `__init__` (line 49) `def __init__(self, config)`
- `scanner` (line 78) `def scanner(self)`
- `generator` (line 84) `def generator(self)`
- `analyzer` (line 90) `def analyzer(self)`
- `security` (line 96) `def security(self)`
- `exporter` (line 102) `def exporter(self)`
- `taint` (line 108) `def taint(self)`
- `dataflow` (line 114) `def dataflow(self)` - *Return the lazily initialised dataflow analyzer.*
- `hotspots` (line 121) `def hotspots(self)`
- `layer_rules` (line 127) `def layer_rules(self)`
- `rule_gen` (line 133) `def rule_gen(self)`
- `sarif` (line 139) `def sarif(self)`
- `cpg` (line 145) `def cpg(self)`
- `layer_detector` (line 154) `def layer_detector(self)`
- `uml` (line 160) `def uml(self)`
- `wiki` (line 166) `def wiki(self)` - *Return the lazily initialised agent wiki generator.*
- `readme_injector` (line 173) `def readme_injector(self)`
- `agent_injector` (line 183) `def agent_injector(self)`
- `agent_output` (line 193) `def agent_output(self)`
- `diagram_builder` (line 199) `def diagram_builder(self)` - *Return the lazily initialised system map builder.*
- `diagram_renderer` (line 206) `def diagram_renderer(self)` - *Return the lazily initialised interactive map renderer.*
- `diagram_validator` (line 213) `def diagram_validator(self)` - *Return the lazily initialised system map validator.*
- `diagram_publisher` (line 220) `def diagram_publisher(self)` - *Return the lazily initialised documentation site publisher.*
- `vis_renderer` (line 227) `def vis_renderer(self)` - *Return the lazily initialised vis.js network renderer.*
- `build_typed_graph` (line 233) `def build_typed_graph(self, nodes, edges, resolved_edges)`
- `make_ranker` (line 243) `def make_ranker(self, typed_graph)` - *Create a CompositeRanker for the given typed graph.*
- `last_category` (line 260) `def last_category(self)`
- `last_typed_graph` (line 264) `def last_typed_graph(self)`
- `__init__` (line 277) `def __init__(self, factory)`
- `run` (line 280) `def run(self, nodes, edges, resolved_edges, layers, content_map)`
...
**Classes:**
- `ReadmeInjector` (line 68) `class ReadmeInjector` - *Injects a link to KNOWLEDGE_BASE.md into the project README.
...
**Methods:**
- `__init__` (line 76) `def __init__(self, kb_filename, agent_output_dir, wiki_output_dir)`
- `inject` (line 86) `def inject(self, project_root)`
- `_extract_current_injection` (line 115) `def _extract_current_injection(content)`
- `_remove_old_injection` (line 124) `def _remove_old_injection(content)`
- `remove` (line 134) `def remove(self, project_root)`
- `_find_readme` (line 163) `def _find_readme(root)`
- `_build_injection` (line 170) `def _build_injection(self, suffix)`
...
- `resolve_all` (line 159) `def resolve_all(self, import_str, source_file)` - *Resolve *import_str* to all possible matching project file paths.
...
- `_resolve_include_dirs` (line 175) `def _resolve_include_dirs(self, import_str)` - *Resolve *import_str* against configured ``-I`` include dirs.
...
- `_resolve_relative` (line 195) `def _resolve_relative(self, import_str, source_file)` - *Resolve a relative import (starts with ``.`` or ``..``).*
- `_resolve_verbatim` (line 213) `def _resolve_verbatim(self, import_str, source_file)` - *Resolve a path-like import verbatim against the source directory.

Covers quoted C-family includes such as ``"utils.h"`` or
``"lib/net.h"`` which name a project file relative to the
including file.*
- `_resolve_extensionless` (line 231) `def _resolve_extensionless(self, import_str, source_file)` - *Resolve a bare module name by appending known extensions.*
- `_resolve_directory_init` (line 240) `def _resolve_directory_init(self, import_str, source_file)` - *Resolve as a package directory with __init__ or index file.*
- `_resolve_module_dotpath` (line 250) `def _resolve_module_dotpath(self, import_str)` - *Resolve a dotted module path (Python/Java convention).*
- `_resolve_suffix_match` (line 272) `def _resolve_suffix_match(self, import_str)` - *Match a slash-qualified include against project path suffixes.

Covers include-directory style references such as
``"kernel/mm.h"`` mapping to ``"include/kernel/mm.h"``. Only
unambiguous matches resolve.*
- `_resolve_basename_match` (line 287) `def _resolve_basename_match(self, import_str)` - *Match by exact file basename including extension.

Covers the classic C pair pattern where ``kernel.h`` is
included but ``kernel.c`` shares its stem: stem matching
stays ambiguous while the basename is unique. Only
unambiguous matches resolve.*
- `_resolve_stem_match` (line 305) `def _resolve_stem_match(self, import_str)` - *Match by file stem only (last resort).*
- `_strip_extension` (line 314) `def _strip_extension(self, name)` - *Remove a trailing known source extension from a file name.
...
- `_load_gitignore` (line 57) `def _load_gitignore(self, root)` - *Parse .gitignore patterns using regex (no external deps).*
- `_gitignore_glob_to_regex` (line 79) `def _gitignore_glob_to_regex(pattern)` - *Convert a .gitignore glob pattern to a regex pattern.*
- `_is_gitignored` (line 119) `def _is_gitignored(self, rel_path)` - *Check if a relative path matches any .gitignore pattern.*
- `_validate_path_security` (line 128) `def _validate_path_security(self, path)` - *Reject symlinks and files exceeding MAX_FILE_SIZE_MB.*
- `_check_directory_depth` (line 141) `def _check_directory_depth(self, path, root)` - *Return ``True`` if *path* is within MAX_DIRECTORY_DEPTH of *root*.*
- `_extract_file_doc` (line 149) `def _extract_file_doc(self, content)` - *Extract a file-level docstring from the first lines of a source file.
...
- `_emit_progress` (line 225) `def _emit_progress(self, count)` - *Emit a progress message every PROGRESS_REPORT_BATCH files.

Args:
    count: Number of files scanned so far.*
- `scan` (line 235) `def scan(self, root)` - *Walk *root* recursively and produce (nodes, edges) for the graph.
...
- `scan_with_content` (line 249) `def scan_with_content(self, root)` - *Scan and also return raw file contents for deeper analysis.

Returns:
    Tuple of (nodes, edges, content_map) where content_map maps
    node_id to raw file content.*
- `_scan_impl` (line 260) `def _scan_impl(self, root)` - *Internal scan implementation returning nodes, edges, and content.*
...
**Classes:**
- `WikiGenerator` (line 120) `class WikiGenerator` - *Generates the navigable agent wiki from scanned topology.*

**Functions:**
- `_is_garbage_purpose` (line 44) `def _is_garbage_purpose(text)` - *Return True for file-doc first lines that state no purpose.*
- `_clean_purpose` (line 55) `def _clean_purpose(text)` - *Return the purpose signal of a doc first line, or empty string.*
- `_slug` (line 74) `def _slug(text)` - *Return a filesystem-safe slug for community labels.*
- `_escape` (line 81) `def _escape(text)` - *Escape markdown table breaking characters in one line of text.*
- `_is_garbage_doc` (line 86) `def _is_garbage_doc(text)` - *Return True for doc lines that carry no purpose signal.*
- `existing_ids` (line 96) `def existing_ids(connections)` - *Return community id pairs already linked, to avoid duplicate edges.*
- `_display_names` (line 106) `def _display_names(communities)` - *Return unique display names, disambiguating duplicate labels.*

**Methods:**
- `__init__` (line 123) `def __init__(self, config)` - *Store configuration for wiki output limits and paths.*
- `generate` (line 128) `def generate(self, nodes, edges, resolved_edges, analysis, layers, findings, analysis_v2, project_root)` - *Write all wiki files and return the output directory path.*
- `_prune_stale_pages` (line 176) `def _prune_stale_pages(self, out_dir, current)` - *Delete community pages from previous runs that are no longer generated.*
- `lint` (line 185) `def lint(self, project_root)` - *Check wiki health and return a list of issue descriptions.*
- `_resolve_communities` (line 208) `def _resolve_communities(self, nodes, analysis, resolved)` - *Return detected communities plus an orphan fallback for leftovers.*
- `_community_of` (line 234) `def _community_of(self, node_id, communities)` - *Return the community containing the given node id.*
- `_build_connections` (line 243) `def _build_connections(self, communities, resolved, analysis, node_map, layers)` - *Derive typed bridges between communities with strength scores.*
- `_duplicate_links` (line 308) `def _duplicate_links(communities, node_map, skip_pairs)` - *Flag community pairs sharing an unusual fraction of symbol names.*
- `_shared_context_links` (line 351) `def _shared_context_links(self, communities, existing, node_map, layers)` - *Infer weak links between otherwise disconnected communities.*
- `_shared_context` (line 387) `def _shared_context(first, second, node_map, layers)` - *Describe shared language or layer between two communities.*
- `_build_connections_json` (line 420) `def _build_connections_json(self, connections)` - *Serialize connections as pretty-printed JSON.*
- `_definition_for` (line 424) `def _definition_for(self, community, node_map)` - *Synthesize a one-paragraph definition for a community.*
- `_file_row` (line 453) `def _file_row(self, fid, node_map, layers)` - *Return a markdown table row for a single file, or empty string.*
- `_build_grouped_files` (line 467) `def _build_grouped_files(self, members, node_map, layers, max_files)` - *List oversized communities grouped by directory within budget.*
- `_build_community_page` (line 516) `def _build_community_page(self, community, node_map, resolved, analysis, layers, findings, analysis_v2, connections)` - *Build the synthesis page for a single community.*
- `_questions_for` (line 669) `def _questions_for(self, community, node_map, member_set, analysis_v2)` - *Generate deterministic open questions for a community.*
- `_large_files` (line 707) `def _large_files(self, nodes, project_root)` - *Return node ids whose on-disk size exceeds the large-file threshold.*
- `_build_index` (line 720) `def _build_index(self, nodes, resolved, analysis, layers, findings, analysis_v2, communities, pages, connections, project_name, project_root)` - *Build the wiki entry point with overview and navigation.*
- `_overview_paragraph` (line 832) `def _overview_paragraph(self, nodes, analysis, layers, findings, analysis_v2, communities)` - *Synthesize the central preoccupations paragraph.*
- `_connective_paragraph` (line 865) `def _connective_paragraph(self, communities, connections)` - *Synthesize the connective tissue paragraph.*
- `_questions_paragraph` (line 886) `def _questions_paragraph(self, analysis, findings, analysis_v2, coverage)` - *Synthesize the open questions paragraph.*
- `_build_queries` (line 902) `def _build_queries(self, analysis)` - *Build the starter question log with feedback loop instructions.*
- `_build_report` (line 927) `def _build_report(self, nodes, edges, resolved, analysis, layers, findings, analysis_v2, communities, project_name, project_root)` - *Build the honest audit report with confidence and limits.*
- `_estimate_tokens` (line 999) `def _estimate_tokens(self, nodes, connections)` - *Estimate wiki read cost as characters divided by four.*
- `_write` (line 1010) `def _write(path, content)` - *Write wiki file content with UTF-8 encoding.*
- `dominant` (line 394) `def dominant(ids, key)`
...
- `create_parser` (line 68) `def create_parser(extension, filename, config)` - *Factory: return a parser instance for the given file extension.*
...
**Classes:**
- `CParser` (line 28) `class CParser(LanguageParser)` - *Parser for C, C++ (.c, .cpp, .cc, .cxx, .h, .hpp, .hxx).

Extracts includes, structs, classes, functions, and preprocessor
macros using regex heuristics tuned to C-family syntax.*

**Functions:**
- `_has_type_prefix` (line 16) `def _has_type_prefix(prefix)` - *Return True when a prototype prefix carries a return type.*

**Methods:**
- `_extract_specifics` (line 35) `def _extract_specifics(self, content)` - *Extract C-family symbols and imports from source content.
