...
<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:1137d23 | date:2026-07-18 -->
...
**Query anchors:** readmenator/_rule_gen.py, tests/test_ranking.py, tests/test_documentation.py, tests/test_rule_gen.py, readmenator/_documentation.py
