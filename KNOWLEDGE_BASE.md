...
**Total Files Parsed:** 76 | **Total Symbols Extracted:** 1007 | **Total Imports:** 471
 | **Resolved Imports:** 228

<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:b5dce63 | date:2026-07-18 -->
...
| Total Imports | 471 |
| Call Edges | 5124 |
| Inheritance Edges | 74 |
| Languages | 1 |
| Avg Symbols/File | 13.2 |
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3391 | 0.3719 | 0.3589 | 0.00 | 1.00 |
| 2 | `_category.py` | 0.2656 | 0.3415 | 0.3195 | 0.00 | 0.48 |
| 3 | `_config.py` | 0.1301 | 0.0425 | 0.0550 | 0.00 | 1.00 |
| 4 | `_rule_gen.py` | 0.1111 | 0.0478 | 0.0037 | 0.00 | 0.89 |
| 5 | `_base.py` | 0.1056 | 0.0000 | 0.0279 | 0.00 | 1.00 |
| 6 | `_resolver.py` | 0.1012 | 0.0000 | 0.0060 | 0.00 | 1.00 |
| 7 | `_query.py` | 0.1010 | 0.0000 | 0.0052 | 0.00 | 1.00 |
| 8 | `_layers.py` | 0.1008 | 0.0000 | 0.0042 | 0.00 | 1.00 |
| 9 | `_scanner.py` | 0.1008 | 0.0000 | 0.0041 | 0.00 | 1.00 |
| 10 | `_analyzer.py` | 0.1007 | 0.0000 | 0.0037 | 0.00 | 1.00 |

**Query anchors:** readmenator/_documentation.py, tests/test_documentation.py, readmenator/_rule_gen.py, tests/test_ranking.py, tests/test_rule_gen.py
...
### readmenator/parsers (Cohesion: 0.87)
...
- `_explain.py` <-> `test_config.py` (4 hops, across 2 communities)
...
- What does _models.py depend on, and what depends on it? (57 connections)
- What does _config.py depend on, and what depends on it? (37 connections)
- What does __init__.py depend on, and what depends on it? (24 connections)
- How are the 18 files in 'readmenator' related to each other?
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.179 | 1.000 | 0.671 | 15 | 68 |
| `_category.py` | 0.298 | 0.206 | 0.243 | 25 | 14 |
| `_config.py` | 0.012 | 0.618 | 0.375 | 1 | 42 |
| `_rule_gen.py` | 0.107 | 0.176 | 0.149 | 9 | 12 |
| `_base.py` | 0.071 | 0.397 | 0.267 | 6 | 27 |
| `_resolver.py` | 0.131 | 0.103 | 0.114 | 11 | 7 |
| `_query.py` | 0.202 | 0.176 | 0.187 | 17 | 12 |
| `_layers.py` | 0.048 | 0.103 | 0.081 | 4 | 7 |
| `_scanner.py` | 0.155 | 0.206 | 0.185 | 13 | 14 |
| `_analyzer.py` | 0.155 | 0.147 | 0.150 | 13 | 10 |
| `test_parsers_property.py` | 0.191 | 0.676 | 0.482 | 16 | 46 |
| `test_ranking.py` | 0.857 | 0.191 | 0.458 | 72 | 13 |
| `test_parsers.py` | 1.000 | 0.088 | 0.453 | 84 | 6 |
| `__init__.py` | 0.024 | 0.691 | 0.424 | 2 | 47 |
| `_app.py` | 0.369 | 0.456 | 0.421 | 31 | 31 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 866 total | py | 866 |
...
- `_run_tests` (line 68) `def _run_tests()`
...
- `export_cypher` (line 473) `def export_cypher(self, target_dir, output_path)`
- `export_obsidian` (line 486) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 496) `def watch(self, target_dir)`
- `audit` (line 506) `def audit(self, target_dir)`
- `audit_deep` (line 513) `def audit_deep(self, target_dir)`
- `export_sarif` (line 533) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 543) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 553) `def detect_layers(self, target_dir)`
- `on_change` (line 500) `def on_change()`
...
**Methods:**
- `__init__` (line 22) `def __init__(self, privacy_mode)`
- `generate` (line 25) `def generate(self, nodes, edges, resolved_edges, analysis, findings)` - *Generate the CPG JSON-LD string embeddable in markdown.
...
- `_severity_counts` (line 142) `def _severity_counts(self, findings)`
- `_build_symbol_list` (line 148) `def _build_symbol_list(self, node)`
- `_compute_node_hash` (line 164) `def _compute_node_hash(node)`
