...
**Total Files Parsed:** 80 | **Total Symbols Extracted:** 1119 | **Total Imports:** 500
 | **Resolved Imports:** 239

<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:dd3e016 | date:2026-07-18 -->
...
| Total Imports | 500 |
| Call Edges | 5700 |
| Inheritance Edges | 88 |
| Languages | 1 |
| Avg Symbols/File | 14.0 |
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3372 | 0.3692 | 0.3553 | 0.00 | 1.00 |
| 2 | `_category.py` | 0.2616 | 0.3384 | 0.3157 | 0.00 | 0.46 |
| 3 | `_config.py` | 0.1310 | 0.0441 | 0.0558 | 0.00 | 1.00 |
| 4 | `_rule_gen.py` | 0.1113 | 0.0481 | 0.0036 | 0.00 | 0.89 |
| 5 | `_base.py` | 0.1054 | 0.0000 | 0.0272 | 0.00 | 1.00 |
| 6 | `_resolver.py` | 0.1012 | 0.0000 | 0.0059 | 0.00 | 1.00 |
| 7 | `_query.py` | 0.1010 | 0.0000 | 0.0050 | 0.00 | 1.00 |
| 8 | `_layers.py` | 0.1008 | 0.0000 | 0.0041 | 0.00 | 1.00 |
| 9 | `_scanner.py` | 0.1008 | 0.0000 | 0.0040 | 0.00 | 1.00 |
| 10 | `_analyzer.py` | 0.1007 | 0.0000 | 0.0036 | 0.00 | 1.00 |

**Query anchors:** readmenator/_rule_gen.py, tests/test_rule_gen.py, tests/test_documentation.py, readmenator/_documentation.py, tests/test_ranking.py
...
### readmenator/parsers (Cohesion: 0.68)
...
- `__init__.py` <-> `test_readme_injector.py` (4 hops, across 2 communities)
- `__init__.py` <-> `test_resolver.py` (4 hops, across 2 communities)
- `_assembly.py` <-> `test_readme_injector.py` (4 hops, across 2 communities)
...
- What does _models.py depend on, and what depends on it? (59 connections)
- What does _config.py depend on, and what depends on it? (39 connections)
- What does __init__.py depend on, and what depends on it? (24 connections)
- How are the 56 files in 'readmenator' related to each other?
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.179 | 1.000 | 0.671 | 15 | 70 |
| `_category.py` | 0.309 | 0.200 | 0.244 | 26 | 14 |
| `_config.py` | 0.012 | 0.629 | 0.382 | 1 | 44 |
| `_rule_gen.py` | 0.107 | 0.171 | 0.146 | 9 | 12 |
| `_base.py` | 0.071 | 0.386 | 0.260 | 6 | 27 |
| `_resolver.py` | 0.131 | 0.100 | 0.112 | 11 | 7 |
| `_query.py` | 0.202 | 0.171 | 0.184 | 17 | 12 |
| `_layers.py` | 0.048 | 0.100 | 0.079 | 4 | 7 |
| `_scanner.py` | 0.155 | 0.200 | 0.182 | 13 | 14 |
| `_analyzer.py` | 0.155 | 0.143 | 0.148 | 13 | 10 |
| `test_parsers_property.py` | 0.191 | 0.657 | 0.470 | 16 | 46 |
| `test_ranking.py` | 0.857 | 0.186 | 0.454 | 72 | 13 |
| `test_parsers.py` | 1.000 | 0.086 | 0.451 | 84 | 6 |
| `_pipeline.py` | 0.274 | 0.557 | 0.444 | 23 | 39 |
| `_app.py` | 0.393 | 0.443 | 0.423 | 33 | 31 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 963 total | py | 963 |
| `RM002` | info | Print statement found (consider logging instead) | python | 8 |
...
classDiagram
  ...
  class _rank_py_CompositeRanker {
    <<class>>
    +global_pagerank(graph, alpha, max_iter, tolerance)
    +personalized_pagerank(graph, seeds, alpha, max_iter, tolerance)
    +hits(graph, max_iter, tolerance)
  ...
  class _readme_injector_py_ReadmeInjector {
    <<class>>
    +__init__(self, kb_filename)
    +inject(self, project_root)
    +remove(self, project_root)
    +_find_readme(root)
    +_build_injection(self, suffix)
  }
  class _resolver_py_ImportResolver {
    <<class>>
    +__init__(self, file_ids, root)
    +_build_stem_index(self, file_ids)
    +_build_dir_index(self, file_ids)
    +resolve(self, import_str, source_file)
    +resolve_all(self, import_str, source_file)
    +_resolve_relative(self, import_str, source_file)
    +_resolve_extensionless(self, import_str, source_file)
    +_resolve_directory_init(self, import_str, source_file)
    +_resolve_module_dotpath(self, import_str)
    +_resolve_stem_match(self, import_str)
  }
  class _rule_gen_py_RuleGenerator {
    <<class>>
    +__init__(self, config)
    +generate(self, nodes, content_map)
    +write_rules(self, rules, output_dir)
    +_group_by_language(self, nodes)
    +_analyze_language(self, lang, nodes, content_map)
    +_detect_antipatterns(self, nodes, content_map)
    +_infer_language_for_rule(rule_id)
    +_next_rule_id(self)
  }
  class _sarif_py_SarifExporter {
    <<class>>
    +__init__(self, privacy_mode)
    +export(self, findings, project_name)
    +_build_rule(self, finding)
    +_build_result(self, finding, rule_index)
  }
  class _scanner_py_PolyglotScanner {
    <<class>>
    +__init__(self, config)
    +_is_ignored(self, path)
    +_load_gitignore(self, root)
    +_gitignore_glob_to_regex(pattern)
    +_is_gitignored(self, rel_path)
    +_validate_path_security(self, path)
    +_check_directory_depth(self, path, root)
    +_extract_file_doc(self, content)
    +_emit_progress(self, count)
    +scan(self, root)
  }
```
...
- `_run_tests` (line 93) `def _run_tests()`
...
- `_write_sidecar_outputs` (line 166) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_inject_readme_link` (line 192) `def _inject_readme_link(self, root)`
- `generate_uml_code` (line 200) `def generate_uml_code(self, target_dir, language, output_path)`
- `_log_summary` (line 212) `def _log_summary(self, nodes, edges, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 266) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 356) `def _scan_for_cache(self, root, cache)`
- `query` (line 374) `def query(self, target_dir, question)`
- `explain` (line 379) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 391) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 404) `def summary(self, target_dir)`
- `rank_query` (line 409) `def rank_query(self, target_dir, query, top_n)` - *Run a ranked query against the knowledge graph.
...
- `rebuild` (line 439) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 442) `def analyze(self, target_dir)`
- `export_json` (line 446) `def export_json(self, target_dir, output_path)`
- `export_html` (line 457) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 468) `def export_svg(self, target_dir, output_path)`
- `export` (line 479) `def export(self, target_dir)`
- `export_graphml` (line 484) `def export_graphml(self, target_dir, output_path)`
- `export_cypher` (line 495) `def export_cypher(self, target_dir, output_path)`
- `export_obsidian` (line 508) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 518) `def watch(self, target_dir)`
- `audit` (line 528) `def audit(self, target_dir)`
- `audit_deep` (line 535) `def audit_deep(self, target_dir)`
- `export_sarif` (line 555) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 565) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 575) `def detect_layers(self, target_dir)`
- `on_change` (line 522) `def on_change()`
...
- `_ranking_version` (line 54) `def _ranking_version(self)`
- `_get_git_commit` (line 72) `def _get_git_commit()`
- `generate` (line 82) `def generate(self, nodes, edges, resolved_edges, analysis, layers, findings, analysis_v2, ranked)`
- `_apply_context_budget` (line 155) `def _apply_context_budget(self, content, nodes, edges, resolved_edges, analysis, analysis_v2, findings)`
- `_build_toc` (line 293) `def _build_toc(self, nodes, analysis, layers, findings, analysis_v2, is_truncated, ranked)`
- `_build_layers` (line 378) `def _build_layers(self, layers, nodes)`
- `_build_dashboard` (line 412) `def _build_dashboard(self, nodes, edges, resolved_edges)`
- `_build_god_nodes` (line 492) `def _build_god_nodes(self, analysis, ranked)`
- `_build_community_analysis` (line 520) `def _build_community_analysis(self, analysis, nodes)`
- `_build_surprising_connections` (line 553) `def _build_surprising_connections(self, analysis, nodes)`
- `_build_suggested_questions` (line 578) `def _build_suggested_questions(self, analysis)`
- `_build_ranked_context` (line 594) `def _build_ranked_context(self, ranked)`
- `_build_orphans` (line 640) `def _build_orphans(self, nodes, analysis_v2, ranked)` - *Build a section listing nodes with low coverage signals.*
- `_build_query_recipes` (line 690) `def _build_query_recipes(self)`
- `_build_taint_analysis` (line 732) `def _build_taint_analysis(self, analysis_v2)`
- `_build_hotspots` (line 767) `def _build_hotspots(self, analysis_v2, ranked)`
- `_build_dependency_cycles` (line 805) `def _build_dependency_cycles(self, analysis_v2)`
- `_build_change_impact` (line 825) `def _build_change_impact(self, analysis_v2)`
- `_build_layer_violations` (line 850) `def _build_layer_violations(self, analysis_v2)`
- `_build_suggested_rules` (line 878) `def _build_suggested_rules(self, analysis_v2)`
- `_build_security_findings` (line 903) `def _build_security_findings(self, findings)`
- `_build_mermaid_section` (line 950) `def _build_mermaid_section(self, graph_output, is_truncated)`
- `_build_uml_diagram` (line 973) `def _build_uml_diagram(self, nodes, edges)`
- `_build_cpg_block` (line 999) `def _build_cpg_block(self, nodes, edges, resolved_edges, analysis)`
- `_build_architecture_reference` (line 1025) `def _build_architecture_reference(self, nodes, edges)`
...
- `DeepAnalysisRunner` (line 184) `class DeepAnalysisRunner` - *Orchestrates the extended V2 analysis pipeline.
...
- `layer_detector` (line 130) `def layer_detector(self)`
- `uml` (line 136) `def uml(self)`
- `readme_injector` (line 142) `def readme_injector(self)`
- `build_typed_graph` (line 149) `def build_typed_graph(self, nodes, edges, resolved_edges)`
- `make_ranker` (line 159) `def make_ranker(self, typed_graph)` - *Create a CompositeRanker for the given typed graph.*
- `last_category` (line 176) `def last_category(self)`
- `last_typed_graph` (line 180) `def last_typed_graph(self)`
- `__init__` (line 193) `def __init__(self, factory)`
- `run` (line 196) `def run(self, nodes, edges, resolved_edges, layers, content_map)`
