...
**Total Files Parsed:** 102 | **Total Symbols Extracted:** 1325 | **Total Imports:** 601
 | **Resolved Imports:** 282

<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:db29a83 | date:2026-07-18 -->
...
| Total Imports | 601 |
| Call Edges | 6838 |
| Inheritance Edges | 107 |
| Languages | 2 |
| Avg Symbols/File | 13.0 |
| Avg Imports/File | 5.9 |
| Resolved Imports | 282 |
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `_models.py` | 0.3291 | 0.3544 | 0.3481 | 0.00 | 1.00 |
| 2 | `_category.py` | 0.2499 | 0.3160 | 0.3079 | 0.00 | 0.46 |
| 3 | `_config.py` | 0.1371 | 0.0560 | 0.0593 | 0.00 | 1.00 |
| 4 | `_layers.py` | 0.1048 | 0.0083 | 0.0055 | 0.00 | 1.00 |
| 5 | `_base.py` | 0.1048 | 0.0000 | 0.0238 | 0.00 | 1.00 |
| 6 | `_rule_gen.py` | 0.1024 | 0.0288 | 0.0031 | 0.00 | 0.89 |
| 7 | `_resolver.py` | 0.1010 | 0.0000 | 0.0051 | 0.00 | 1.00 |
| 8 | `_query.py` | 0.1009 | 0.0001 | 0.0044 | 0.00 | 1.00 |
| 9 | `_scanner.py` | 0.1007 | 0.0000 | 0.0035 | 0.00 | 1.00 |
| 10 | `_analyzer.py` | 0.1006 | 0.0000 | 0.0031 | 0.00 | 1.00 |

**Query anchors:** tests/test_ranking.py, readmenator/_rule_gen.py, readmenator/_documentation.py, tests/test_documentation.py, readmenator/_agent_output.py, tests/test_rule_gen.py, tests/test_agent_output.py, tests/test_linter.py (+1 more)
...
### readmenator (Cohesion: 0.87)

**66 files** in this community:
...
- What does _models.py depend on, and what depends on it? (69 connections)
- What does _config.py depend on, and what depends on it? (49 connections)
- What does __init__.py depend on, and what depends on it? (24 connections)
- How are the 66 files in 'readmenator' related to each other?
...
**Taint Sources:** 1 | **Taint Sinks:** 33 | **Propagation Paths:** 20
...
- `_agent_injector.py` imports `subprocess` (5 hops to `_category.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _mcp_server.py -> _query.py -> ...
- `_agent_injector.py` imports `subprocess` (5 hops to `_uml.py`) [high]
  Path: _agent_injector.py -> readmenator.py -> __main__.py -> _app.py -> _pipeline.py -> ...
...
|------|-----------|------------|----------|---------|-------------|
| `_models.py` | 0.226 | 1.000 | 0.691 | 19 | 82 |
| `_category.py` | 0.309 | 0.171 | 0.226 | 26 | 14 |
| `_config.py` | 0.012 | 0.671 | 0.407 | 1 | 55 |
| `_layers.py` | 0.048 | 0.110 | 0.085 | 4 | 9 |
| `_base.py` | 0.071 | 0.329 | 0.226 | 6 | 27 |
| `_rule_gen.py` | 0.107 | 0.146 | 0.131 | 9 | 12 |
| `_resolver.py` | 0.131 | 0.085 | 0.104 | 11 | 7 |
| `_query.py` | 0.202 | 0.146 | 0.169 | 17 | 12 |
| `_scanner.py` | 0.155 | 0.171 | 0.164 | 13 | 14 |
| `_analyzer.py` | 0.155 | 0.122 | 0.135 | 13 | 10 |
| `test_parsers.py` | 1.000 | 0.073 | 0.444 | 84 | 6 |
| `test_ranking.py` | 0.857 | 0.159 | 0.438 | 72 | 13 |
| `_app.py` | 0.452 | 0.427 | 0.437 | 38 | 35 |
| `_pipeline.py` | 0.298 | 0.524 | 0.434 | 25 | 43 |
| `test_agent_output.py` | 0.488 | 0.366 | 0.415 | 41 | 30 |
...
|---------|----------|-------------|----------|---------|
| `RM001` | info | Large number of functions in py: 1140 total | py | 1140 |
...
- `_run_tests` (line 101) `def _run_tests()`
...
- `_write_sidecar_outputs` (line 182) `def _write_sidecar_outputs(self, root, findings, analysis_v2)`
- `_inject_readme_link` (line 208) `def _inject_readme_link(self, root)`
- `_inject_agent_files` (line 216) `def _inject_agent_files(self, root)`
- `generate_uml_code` (line 224) `def generate_uml_code(self, target_dir, language, output_path)`
- `_log_summary` (line 236) `def _log_summary(self, nodes, edges, root, resolved_edges, analysis, layer_summary, analysis_v2, findings)`
- `update` (line 291) `def update(self, target_dir, run_security)`
- `_scan_for_cache` (line 387) `def _scan_for_cache(self, root, cache)`
- `query` (line 405) `def query(self, target_dir, question)`
- `explain` (line 410) `def explain(self, target_dir, symbol_name)`
- `find_path` (line 422) `def find_path(self, target_dir, symbol_a, symbol_b)`
- `summary` (line 435) `def summary(self, target_dir)`
- `rank_query` (line 440) `def rank_query(self, target_dir, query, top_n)` - *Run a ranked query against the knowledge graph.
...
- `rebuild` (line 470) `def rebuild(self, target_dir, run_security)`
- `analyze` (line 473) `def analyze(self, target_dir)`
- `export_json` (line 477) `def export_json(self, target_dir, output_path)`
- `export_html` (line 488) `def export_html(self, target_dir, output_path)`
- `export_svg` (line 499) `def export_svg(self, target_dir, output_path)`
- `export` (line 510) `def export(self, target_dir)`
- `export_graphml` (line 515) `def export_graphml(self, target_dir, output_path)`
- `export_cypher` (line 526) `def export_cypher(self, target_dir, output_path)`
- `export_obsidian` (line 539) `def export_obsidian(self, target_dir, output_dir)`
- `watch` (line 549) `def watch(self, target_dir)`
- `audit` (line 559) `def audit(self, target_dir)`
- `audit_deep` (line 566) `def audit_deep(self, target_dir)`
- `export_sarif` (line 586) `def export_sarif(self, target_dir, output_path)`
- `export_rules` (line 596) `def export_rules(self, target_dir, output_dir)`
- `detect_layers` (line 606) `def detect_layers(self, target_dir)`
- `lint` (line 616) `def lint(self, target_dir)`
- `strip_dead_code` (line 629) `def strip_dead_code(self, target_dir)`
- `generate_cursorrules` (line 639) `def generate_cursorrules(self, target_dir)`
- `refactor_monolith` (line 654) `def refactor_monolith(self, target_dir)`
- `on_change` (line 553) `def on_change()`
...
**Classes:**
- `AnalyzerFactory` (line 38) `class AnalyzerFactory` - *Lazy factory for all readmenator analyzer and generator instances.

Decouples the application orchestrator from the concrete
instantiation of analysis modules. Each component is created
on first access and cached for the lifetime of the factory.*
- `DeepAnalysisRunner` (line 207) `class DeepAnalysisRunner` - *Orchestrates the extended V2 analysis pipeline.
...
- `scanner` (line 68) `def scanner(self)`
- `generator` (line 74) `def generator(self)`
- `analyzer` (line 80) `def analyzer(self)`
- `security` (line 86) `def security(self)`
- `exporter` (line 92) `def exporter(self)`
- `taint` (line 98) `def taint(self)`
- `hotspots` (line 104) `def hotspots(self)`
- `layer_rules` (line 110) `def layer_rules(self)`
- `rule_gen` (line 116) `def rule_gen(self)`
- `sarif` (line 122) `def sarif(self)`
- `cpg` (line 128) `def cpg(self)`
- `layer_detector` (line 137) `def layer_detector(self)`
- `uml` (line 143) `def uml(self)`
- `readme_injector` (line 149) `def readme_injector(self)`
- `agent_injector` (line 158) `def agent_injector(self)`
- `agent_output` (line 167) `def agent_output(self)`
- `build_typed_graph` (line 172) `def build_typed_graph(self, nodes, edges, resolved_edges)`
- `make_ranker` (line 182) `def make_ranker(self, typed_graph)` - *Create a CompositeRanker for the given typed graph.*
- `last_category` (line 199) `def last_category(self)`
- `last_typed_graph` (line 203) `def last_typed_graph(self)`
- `__init__` (line 216) `def __init__(self, factory)`
- `run` (line 219) `def run(self, nodes, edges, resolved_edges, layers, content_map)`
