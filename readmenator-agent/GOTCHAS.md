...
- `readmenator/_models.py` (score: 139.90)
- `readmenator/_config.py` (score: 98.10)
- `readmenator/parsers/__init__.py` (score: 48.20)
- `readmenator/parsers/_base.py` (score: 44.60)
- `readmenator/_pipeline.py` (score: 44.50)
- `tests/test_parsers_property.py` (score: 41.60)
- `readmenator/_app.py` (score: 39.80)
- `readmenator/_mcp_server.py` (score: 21.20)
- `readmenator/_documentation.py` (score: 18.70)
- `readmenator/_category.py` (score: 18.60)
...
- `tests/test_ranking.py` -- complexity: 0.9, centrality: 0.2, combined: 0.4
- `readmenator/_app.py` -- complexity: 0.5, centrality: 0.4, combined: 0.4
- `readmenator/_pipeline.py` -- complexity: 0.3, centrality: 0.5, combined: 0.4
- `tests/test_agent_output.py` -- complexity: 0.5, centrality: 0.4, combined: 0.4
- `tests/test_parsers_property.py` -- complexity: 0.2, centrality: 0.6, combined: 0.4
...
- `tests/test_security.py` -- complexity: 0.8, centrality: 0.1, combined: 0.4
