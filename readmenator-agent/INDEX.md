...
| `readmenator/__init__.py` | - | readmenator | 0 |
| `readmenator/__main__.py` | - | readmenator | 3 |
| `readmenator/_agent_injector.py` | - | readmenator | 12 |
| `readmenator/_agent_output.py` | - | readmenator | 15 |
| `readmenator/_analyzer.py` | - | readmenator | 13 |
| `readmenator/_app.py` | - | readmenator | 42 |
| `readmenator/_cache.py` | - | readmenator | 13 |
| `readmenator/_category.py` | - | readmenator | 26 |
| `readmenator/_config.py` | - | readmenator | 1 |
| `readmenator/_cpg.py` | - | readmenator | 6 |
| `readmenator/_cursorrules_generator.py` | - | readmenator | 8 |
| `readmenator/_dead_code.py` | - | readmenator | 5 |
| `readmenator/_diagrams.py` | - | readmenator | 67 |
| `readmenator/_documentation.py` | - | readmenator | 27 |
| `readmenator/_explain.py` | - | readmenator | 3 |
| `readmenator/_exporter.py` | - | readmenator | 15 |
| `readmenator/_hotspots.py` | - | readmenator | 7 |
| `readmenator/_layer_rules.py` | - | readmenator | 4 |
| `readmenator/_layers.py` | - | readmenator | 4 |
| `readmenator/_linter.py` | - | readmenator | 7 |
| `readmenator/_mcp_server.py` | - | readmenator | 52 |
| `readmenator/_mermaid.py` | - | readmenator | 4 |
| `readmenator/_models.py` | - | readmenator | 19 |
| `readmenator/_pipeline.py` | - | readmenator | 30 |
| `readmenator/_projections.py` | - | readmenator | 15 |
| `readmenator/_query.py` | - | readmenator | 17 |
| `readmenator/_rank.py` | - | readmenator | 17 |
| `readmenator/_readme_injector.py` | - | readmenator | 8 |
| `readmenator/_refactorizer.py` | - | readmenator | 9 |
| `readmenator/_resolver.py` | - | readmenator | 14 |
| `readmenator/_rule_gen.py` | - | readmenator | 9 |
| `readmenator/_sarif.py` | - | readmenator | 5 |
| `readmenator/_scanner.py` | - | readmenator | 13 |
| `readmenator/_security.py` | - | readmenator | 31 |
| `readmenator/_taint.py` | - | readmenator | 6 |
| `readmenator/_uml.py` | - | readmenator | 25 |
| `readmenator/_watcher.py` | - | readmenator | 5 |
...
| `readmenator/parsers/_c.py` | - | parsers | 2 |
...
| `tests/test_agent_injector.py` | - | tests | 38 |
| `tests/test_agent_output.py` | - | tests | 41 |
| `tests/test_analyzer.py` | - | tests | 12 |
| `tests/test_cache.py` | - | tests | 22 |
| `tests/test_config.py` | - | tests | 6 |
| `tests/test_cpg.py` | - | tests | 11 |
| `tests/test_cursorrules.py` | - | tests | 12 |
| `tests/test_dead_code.py` | - | tests | 15 |
| `tests/test_diagrams.py` | - | tests | 69 |
| `tests/test_documentation.py` | - | tests | 29 |
| `tests/test_exporter.py` | - | tests | 15 |
| `tests/test_hotspots.py` | - | tests | 11 |
| `tests/test_integration.py` | - | tests | 16 |
| `tests/test_layer_rules.py` | - | tests | 13 |
| `tests/test_linter.py` | - | tests | 14 |
| `tests/test_mcp_server.py` | - | tests | 25 |
| `tests/test_mermaid.py` | - | tests | 11 |
| `tests/test_models.py` | - | tests | 11 |
| `tests/test_parsers.py` | - | tests | 85 |
| `tests/test_parsers_new.py` | - | tests | 36 |
| `tests/test_parsers_property.py` | - | tests | 27 |
| `tests/test_query.py` | - | tests | 18 |
| `tests/test_ranking.py` | - | tests | 72 |
| `tests/test_readme_injector.py` | - | tests | 26 |
| `tests/test_refactorizer.py` | - | tests | 17 |
| `tests/test_resolver.py` | - | tests | 22 |
| `tests/test_rule_gen.py` | - | tests | 10 |
| `tests/test_sarif.py` | - | tests | 10 |
| `tests/test_scanner.py` | - | tests | 17 |
| `tests/test_security.py` | - | tests | 63 |
| `tests/test_taint.py` | - | tests | 10 |
| `tests/test_taint_bdd.py` | - | tests | 26 |
| `tests/test_uml.py` | - | tests | 49 |
