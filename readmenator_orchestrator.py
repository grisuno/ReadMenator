...
class Config:
    ...
    pr_body_template: str = (
        ...
        "This PR adds `KNOWLEDGE_BASE.md` and `readmenator-agent/` to the root, "
        "plus `docs/KNOWLEDGE_BASE.md`.\n\n"
...
class RepositoryProcessor:
    ...
    def _copy_to_docs_dir(self, repo_dir: Path, generated_file: Path) -> None:
        ...
        agent_dir = repo_dir / self.config.agent_output_dir
        if agent_dir.is_dir():
            docs_agent_dir = docs_dir / self.config.agent_output_dir
            if docs_agent_dir.exists():
                shutil.rmtree(docs_agent_dir)
            shutil.copytree(agent_dir, docs_agent_dir)
        ...
        try:
            ...
            subprocess.run(
                [
                    ...
                    f"{self.config.agent_output_dir}/",
                    f"{self.config.docs_subdir}/{self.config.agent_output_dir}/",
                ],
                cwd=repo_dir, check=True, capture_output=True, env=env,
            )
...
class TestOrchestrator(unittest.TestCase):
    ...
    def test_config_defaults(self) -> None:
        ...
        self.assertEqual(default_config.agent_output_dir, "readmenator-agent")
